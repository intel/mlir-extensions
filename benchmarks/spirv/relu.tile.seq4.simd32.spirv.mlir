...
module attributes {gpu.container_module, torch.debug_module_name = "ReLU"} {
  ...
  func.func @forward(%arg0: memref<512x640x20x15xf32>) -> memref<512x640x20x15xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @forward_kernel::@forward_kernel blocks in (%c24000, %c1, %c1) threads in (%c32, %c32, %c1) args(%c4096 : index, %c128 : index, %c32 : index, %collapse_shape : memref<98304000xf32>, %cst : f32, %memref_0 : memref<98304000xf32>, %c0 : index, %c4 : index, %c1 : index)
  ...
  spirv.module @__spv__forward_kernel Physical64 OpenCL requires #spirv.vce<v1.0, [Int64, Kernel, Addresses], []> attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    ...
    spirv.func @forward_kernel(%arg0: i64, %arg1: i64, %arg2: i64, %arg3: !spirv.ptr<!spirv.array<98304000 x f32>, CrossWorkgroup>, %arg4: f32, %arg5: !spirv.ptr<!spirv.array<98304000 x f32>, CrossWorkgroup>, %arg6: i64, %arg7: i64, %arg8: i64) "None" attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 24000, 1, 1>, workgroup_attributions = 0 : i64} {
  ...
  gpu.module @forward_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @forward_kernel(%arg0: index, %arg1: index, %arg2: index, %arg3: memref<98304000xf32>, %arg4: f32, %arg5: memref<98304000xf32>, %arg6: index, %arg7: index, %arg8: index) kernel attributes {gpu.known_block_size = array<i32: 32, 32, 1>, gpu.known_grid_size = array<i32: 24000, 1, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      %0 = gpu.block_id  x
      %1 = gpu.thread_id  x
      %2 = gpu.thread_id  y
