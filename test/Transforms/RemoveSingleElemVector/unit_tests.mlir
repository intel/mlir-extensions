...
module {
  gpu.module @test_kernels {
    gpu.func @bcast_add_exp(%arg0: vector<1x16xf16>, %arg1: vector<16x1xf16>, %arg2: memref<8x16xf32>) kernel {
      ...
      %45 = vector.broadcast %44 : f16 to vector<16xf16>
      %46 = vector.extract %29[0] : f16 from vector<1xf16>
      %47 = vector.broadcast %46 : f16 to vector<16xf16>
      %48 = vector.extract %30[0] : f16 from vector<1xf16>
      %49 = vector.broadcast %48 : f16 to vector<16xf16>
      %50 = vector.extract %31[0] : f16 from vector<1xf16>
      %51 = vector.broadcast %50 : f16 to vector<16xf16>
      %52 = vector.extract %32[0] : f16 from vector<1xf16>
      %53 = vector.broadcast %52 : f16 to vector<16xf16>
      %54 = vector.extract %33[0] : f16 from vector<1xf16>
      %55 = vector.broadcast %54 : f16 to vector<16xf16>
      %56 = vector.extract %34[0] : f16 from vector<1xf16>
      %57 = vector.broadcast %56 : f16 to vector<16xf16>
      %58 = vector.extract %35[0] : f16 from vector<1xf16>
      %59 = vector.broadcast %58 : f16 to vector<16xf16>
      %60 = vector.extract %36[0] : f16 from vector<1xf16>
      %61 = vector.broadcast %60 : f16 to vector<16xf16>
      %62 = vector.extract %37[0] : f16 from vector<1xf16>
      %63 = vector.broadcast %62 : f16 to vector<16xf16>
      %64 = vector.extract %38[0] : f16 from vector<1xf16>
      %65 = vector.broadcast %64 : f16 to vector<16xf16>
      %66 = vector.extract %39[0] : f16 from vector<1xf16>
      %67 = vector.broadcast %66 : f16 to vector<16xf16>
      %68 = vector.extract %40[0] : f16 from vector<1xf16>
      %69 = vector.broadcast %68 : f16 to vector<16xf16>
      %70 = vector.extract %41[0] : f16 from vector<1xf16>
      %71 = vector.broadcast %70 : f16 to vector<16xf16>
      %72 = vector.extract %42[0] : f16 from vector<1xf16>
      %73 = vector.broadcast %72 : f16 to vector<16xf16>
      %74 = vector.extract %43[0] : f16 from vector<1xf16>
      %75 = vector.broadcast %74 : f16 to vector<16xf16>
