...
func.func @addt(%arg0: memref<2x5xf32>, %arg1: memref<2x5xf32>) -> memref<2x5xf32> {
  ...
  gpu.launch blocks(%arg2, %arg3, %arg4) in (%arg8 = %c1, %arg9 = %c1, %arg10 = %c1) threads(%arg5, %arg6, %arg7) in (%arg11 = %c1, %arg12 = %c1, %arg13 = %c1) {
    ...
    %src_tile = xegpu.create_nd_tdesc %arg0 : memref<2x5xf32> -> !xegpu.tensor_desc<2x5xf32>
    %src_value = xegpu.load_nd %src_tile[%c0, %c0]  : !xegpu.tensor_desc<2x5xf32> -> vector<2x5xf32>
    %res_tile = xegpu.create_nd_tdesc %arg1 : memref<2x5xf32> -> !xegpu.tensor_desc<2x5xf32>
