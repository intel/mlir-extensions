// RUN: %python_executable %imex_runner -i %s --pass-pipeline-file=%p/linalg-to-cpu.pp --runner mlir-cpu-runner -e main --shared-libs=%mlir_runner_utils --entry-point-result=void | FileCheck %s --check-prefix=CPU
...
module @jit__logsm_from_logmhalo_jax_kern.0 {
  ...
  func.func @main() {
    ...
    //      CPU: Unranked Memref base@ = {{(0x)?[-9a-f]*}}
    // CPU-SAME: rank = 1 offset = 0 sizes = [500] strides = [1] data =
    //      CPU: [1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002,
    //      CPU:  1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002,
    //      CPU:  1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002,
    //      CPU:  1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002,
    //      CPU:  1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002, 1.00002,
