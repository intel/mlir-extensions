...
module @jit_pionless_2b_lo.41 {
  func @main(%arg0: tensor<f64>) -> tensor<6xf64> {
    ...
    %29 = linalg.init_tensor [] : tensor<f64>
    ...
    %49 = linalg.init_tensor [] : tensor<f64>
    ...
    %52 = linalg.init_tensor [6] : tensor<6xf64>
    ...
    %54 = linalg.init_tensor [6] : tensor<6xf64>
