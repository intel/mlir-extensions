...
module @jit__get_met_weights_singlegal.43 {
  func @main(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<23xf32>) -> tensor<22xf32> {
    %0 = call @triweighted_histogram.170(%arg0, %arg1, %arg2) : (tensor<f32>, tensor<f32>, tensor<23xf32>) -> tensor<22xf32>
    ...
    %6 = call @_where.184(%5, %cst_1, %3) : (tensor<i1>, tensor<f32>, tensor<f32>) -> tensor<f32>
    ...
    %11 = call @_fill_empty_weights_singlegal.214(%arg0, %arg2, %10) : (tensor<f32>, tensor<23xf32>, tensor<22xf32>) -> tensor<22xf32>
    return %11 : tensor<22xf32>
  }
  func private @triweighted_histogram.170(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<23xf32>) -> tensor<22xf32> {
    ...
    %2 = call @_triweighted_histogram_kernel.164(%arg0, %arg1, %0, %1) : (tensor<f32>, tensor<f32>, tensor<22xf32>, tensor<22xf32>) -> tensor<22xf32>
    return %2 : tensor<22xf32>
  }
  func private @_triweighted_histogram_kernel.164(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<22xf32>, %arg3: tensor<22xf32>) -> tensor<22xf32> {
    %0 = call @vmap__triweighted_histogram_kernel_.156(%arg0, %arg1, %arg2, %arg3) : (tensor<f32>, tensor<f32>, tensor<22xf32>, tensor<22xf32>) -> tensor<22xf32>
    return %0 : tensor<22xf32>
  }
  func private @vmap__triweighted_histogram_kernel_.156(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<22xf32>, %arg3: tensor<22xf32>) -> tensor<22xf32> {
    %0 = call @vmap__tw_cuml_kern_.31(%arg0, %arg2, %arg1) : (tensor<f32>, tensor<22xf32>, tensor<f32>) -> tensor<22xf32>
    %1 = call @vmap__tw_cuml_kern__2.106(%arg0, %arg3, %arg1) : (tensor<f32>, tensor<22xf32>, tensor<f32>) -> tensor<22xf32>
  ...
  func private @vmap__tw_cuml_kern_.31(%arg0: tensor<f32>, %arg1: tensor<22xf32>, %arg2: tensor<f32>) -> tensor<22xf32> {
    ...
    %42 = call @vmap__where_.17(%11, %cst_4, %41) : (tensor<22xi1>, tensor<i32>, tensor<22xf32>) -> tensor<22xf32>
    %43 = call @vmap__where__1.24(%9, %cst_1, %42) : (tensor<22xi1>, tensor<i32>, tensor<22xf32>) -> tensor<22xf32>
  ...
  func private @vmap__where_.17(%arg0: tensor<22xi1>, %arg1: tensor<i32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
  ...
  func private @vmap__where__1.24(%arg0: tensor<22xi1>, %arg1: tensor<i32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [] : tensor<f32>
    %1 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = []} ins(%arg1 : tensor<i32>) outs(%0 : tensor<f32>) {
    ^bb0(%arg3: i32, %arg4: f32):
      %6 = arith.sitofp %arg3 : i32 to f32
  ...
  func private @vmap__tw_cuml_kern__2.106(%arg0: tensor<f32>, %arg1: tensor<22xf32>, %arg2: tensor<f32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [22] : tensor<22xf32>
    %1 = linalg.generic {indexing_maps = [#map1, #map0], iterator_types = ["parallel"]} ins(%arg0 : tensor<f32>) outs(%0 : tensor<22xf32>) {
    ^bb0(%arg3: f32, %arg4: f32):
      linalg.yield %arg3 : f32
    ...
    %42 = call @vmap__where__3.92(%11, %cst_4, %41) : (tensor<22xi1>, tensor<i32>, tensor<22xf32>) -> tensor<22xf32>
    %43 = call @vmap__where__4.99(%9, %cst_1, %42) : (tensor<22xi1>, tensor<i32>, tensor<22xf32>) -> tensor<22xf32>
    return %43 : tensor<22xf32>
  }
  ...
  func private @vmap__where__3.92(%arg0: tensor<22xi1>, %arg1: tensor<i32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [] : tensor<f32>
    %1 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = []} ins(%arg1 : tensor<i32>) outs(%0 : tensor<f32>) {
    ^bb0(%arg3: i32, %arg4: f32):
      %6 = arith.sitofp %arg3 : i32 to f32
  ...
  func private @vmap__where__4.99(%arg0: tensor<22xi1>, %arg1: tensor<i32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [] : tensor<f32>
    %1 = linalg.generic {indexing_maps = [#map2, #map2], iterator_types = []} ins(%arg1 : tensor<i32>) outs(%0 : tensor<f32>) {
    ^bb0(%arg3: i32, %arg4: f32):
      %6 = arith.sitofp %arg3 : i32 to f32
  ...
  func private @_where.184(%arg0: tensor<i1>, %arg1: tensor<f32>, %arg2: tensor<f32>) -> tensor<f32> {
    %0 = linalg.init_tensor [] : tensor<f32>
  ...
  func private @_fill_empty_weights_singlegal.214(%arg0: tensor<f32>, %arg1: tensor<23xf32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    ...
    %19 = call @_where_5.202(%17, %18, %arg2) : (tensor<i1>, tensor<22xf32>, tensor<22xf32>) -> tensor<22xf32>
    %20 = call @_where_6.208(%10, %11, %19) : (tensor<i1>, tensor<22xf32>, tensor<22xf32>) -> tensor<22xf32>
    return %20 : tensor<22xf32>
  }
  func private @_where_5.202(%arg0: tensor<i1>, %arg1: tensor<22xf32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [22] : tensor<22xi1>
  ...
  func private @_where_6.208(%arg0: tensor<i1>, %arg1: tensor<22xf32>, %arg2: tensor<22xf32>) -> tensor<22xf32> {
    %0 = linalg.init_tensor [22] : tensor<22xi1>
    %1 = linalg.generic {indexing_maps = [#map1, #map0], iterator_types = ["parallel"]} ins(%arg0 : tensor<i1>) outs(%0 : tensor<22xi1>) {
    ^bb0(%arg3: i1, %arg4: i1):
      linalg.yield %arg3 : i1
