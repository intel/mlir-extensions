...
module @jit__net_loss.91 {
  func @main(%arg0: tensor<13x13xf32>, %arg1: tensor<13xf32>, %arg2: tensor<13x32xf32>, %arg3: tensor<32xf32>, %arg4: tensor<32x16xf32>, %arg5: tensor<16xf32>, %arg6: tensor<16x8xf32>, %arg7: tensor<8xf32>, %arg8: tensor<8x4xf32>, %arg9: tensor<4xf32>, %arg10: tensor<4x6xf32>, %arg11: tensor<6xf32>, %arg12: tensor<20x13xf32>, %arg13: tensor<20x6xf32>) -> tensor<f32> {
    %cst = arith.constant 0.000000e+00 : f32
    %0 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %5 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %7 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %9 = call @selu.45(%8) : (tensor<20x13xf32>) -> tensor<20x13xf32>
    %cst_0 = arith.constant 0.000000e+00 : f32
    %10 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
    ...
    %19 = call @selu_1.83(%18) : (tensor<20x32xf32>) -> tensor<20x32xf32>
    %cst_1 = arith.constant 0.000000e+00 : f32
    %20 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
    ...
    %29 = call @selu_5.121(%28) : (tensor<20x16xf32>) -> tensor<20x16xf32>
    %cst_2 = arith.constant 0.000000e+00 : f32
    %30 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
    ...
    %39 = call @selu_9.159(%38) : (tensor<20x8xf32>) -> tensor<20x8xf32>
    %cst_3 = arith.constant 0.000000e+00 : f32
    %40 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
    ...
    %49 = call @selu_13.197(%48) : (tensor<20x4xf32>) -> tensor<20x4xf32>
    %cst_4 = arith.constant 0.000000e+00 : f32
    %50 = linalg.init_tensor [20, 6] : tensor<20x6xf32>
    ...
    %59 = call @_mse.215(%58, %arg13) : (tensor<20x6xf32>, tensor<20x6xf32>) -> tensor<f32>
    return %59 : tensor<f32>
  }
  func private @selu.45(%arg0: tensor<20x13xf32>) -> tensor<20x13xf32> {
    %cst = arith.constant dense<1.67326319> : tensor<f32>
    %0 = call @elu.32(%arg0, %cst) : (tensor<20x13xf32>, tensor<f32>) -> tensor<20x13xf32>
    %cst_0 = arith.constant dense<1.05070102> : tensor<f32>
    %cst_1 = arith.constant dense<1.05070102> : tensor<20x13xf32>
    %1 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
  ...
  func private @elu.32(%arg0: tensor<20x13xf32>, %arg1: tensor<f32>) -> tensor<20x13xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<20x13xf32>
    %0 = linalg.init_tensor [20, 13] : tensor<20x13xi1>
    ...
    %2 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %4 = linalg.init_tensor [20, 13] : tensor<20x13xi1>
    ...
    %6 = call @_where.21(%5, %cst_1, %arg0) : (tensor<20x13xi1>, tensor<f32>, tensor<20x13xf32>) -> tensor<20x13xf32>
    %7 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %9 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
    ...
    %11 = call @_where_0.27(%1, %arg0, %10) : (tensor<20x13xi1>, tensor<20x13xf32>, tensor<20x13xf32>) -> tensor<20x13xf32>
    return %11 : tensor<20x13xf32>
  }
  func private @_where.21(%arg0: tensor<20x13xi1>, %arg1: tensor<f32>, %arg2: tensor<20x13xf32>) -> tensor<20x13xf32> {
    %0 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
  ...
  func private @_where_0.27(%arg0: tensor<20x13xi1>, %arg1: tensor<20x13xf32>, %arg2: tensor<20x13xf32>) -> tensor<20x13xf32> {
    %0 = linalg.init_tensor [20, 13] : tensor<20x13xf32>
  ...
  func private @selu_1.83(%arg0: tensor<20x32xf32>) -> tensor<20x32xf32> {
    %cst = arith.constant dense<1.67326319> : tensor<f32>
    %0 = call @elu_2.70(%arg0, %cst) : (tensor<20x32xf32>, tensor<f32>) -> tensor<20x32xf32>
    %cst_0 = arith.constant dense<1.05070102> : tensor<f32>
    %cst_1 = arith.constant dense<1.05070102> : tensor<20x32xf32>
    %1 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
  ...
  func private @elu_2.70(%arg0: tensor<20x32xf32>, %arg1: tensor<f32>) -> tensor<20x32xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<20x32xf32>
    %0 = linalg.init_tensor [20, 32] : tensor<20x32xi1>
    ...
    %cst_1 = arith.constant dense<0.000000e+00> : tensor<f32>
    %6 = call @_where_3.59(%5, %cst_1, %arg0) : (tensor<20x32xi1>, tensor<f32>, tensor<20x32xf32>) -> tensor<20x32xf32>
    %7 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%6 : tensor<20x32xf32>) outs(%7 : tensor<20x32xf32>) {
    ^bb0(%arg2: f32, %arg3: f32):
      %12 = math.expm1 %arg2 : f32
      linalg.yield %12 : f32
    } -> tensor<20x32xf32>
    %9 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
    ...
    %11 = call @_where_4.65(%1, %arg0, %10) : (tensor<20x32xi1>, tensor<20x32xf32>, tensor<20x32xf32>) -> tensor<20x32xf32>
    return %11 : tensor<20x32xf32>
  }
  func private @_where_3.59(%arg0: tensor<20x32xi1>, %arg1: tensor<f32>, %arg2: tensor<20x32xf32>) -> tensor<20x32xf32> {
    %0 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
  ...
  func private @_where_4.65(%arg0: tensor<20x32xi1>, %arg1: tensor<20x32xf32>, %arg2: tensor<20x32xf32>) -> tensor<20x32xf32> {
    %0 = linalg.init_tensor [20, 32] : tensor<20x32xf32>
  ...
  func private @selu_5.121(%arg0: tensor<20x16xf32>) -> tensor<20x16xf32> {
    %cst = arith.constant dense<1.67326319> : tensor<f32>
    %0 = call @elu_6.108(%arg0, %cst) : (tensor<20x16xf32>, tensor<f32>) -> tensor<20x16xf32>
    %cst_0 = arith.constant dense<1.05070102> : tensor<f32>
    %cst_1 = arith.constant dense<1.05070102> : tensor<20x16xf32>
    %1 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
  ...
  func private @elu_6.108(%arg0: tensor<20x16xf32>, %arg1: tensor<f32>) -> tensor<20x16xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<20x16xf32>
    %0 = linalg.init_tensor [20, 16] : tensor<20x16xi1>
    ...
    %cst_1 = arith.constant dense<0.000000e+00> : tensor<f32>
    %6 = call @_where_7.97(%5, %cst_1, %arg0) : (tensor<20x16xi1>, tensor<f32>, tensor<20x16xf32>) -> tensor<20x16xf32>
    %7 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%6 : tensor<20x16xf32>) outs(%7 : tensor<20x16xf32>) {
    ^bb0(%arg2: f32, %arg3: f32):
      %12 = math.expm1 %arg2 : f32
      linalg.yield %12 : f32
    } -> tensor<20x16xf32>
    %9 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
    ...
    %11 = call @_where_8.103(%1, %arg0, %10) : (tensor<20x16xi1>, tensor<20x16xf32>, tensor<20x16xf32>) -> tensor<20x16xf32>
    return %11 : tensor<20x16xf32>
  }
  func private @_where_7.97(%arg0: tensor<20x16xi1>, %arg1: tensor<f32>, %arg2: tensor<20x16xf32>) -> tensor<20x16xf32> {
    %0 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
  ...
  func private @_where_8.103(%arg0: tensor<20x16xi1>, %arg1: tensor<20x16xf32>, %arg2: tensor<20x16xf32>) -> tensor<20x16xf32> {
    %0 = linalg.init_tensor [20, 16] : tensor<20x16xf32>
  ...
  func private @selu_9.159(%arg0: tensor<20x8xf32>) -> tensor<20x8xf32> {
    %cst = arith.constant dense<1.67326319> : tensor<f32>
    %0 = call @elu_10.146(%arg0, %cst) : (tensor<20x8xf32>, tensor<f32>) -> tensor<20x8xf32>
    %cst_0 = arith.constant dense<1.05070102> : tensor<f32>
    %cst_1 = arith.constant dense<1.05070102> : tensor<20x8xf32>
    %1 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
  ...
  func private @elu_10.146(%arg0: tensor<20x8xf32>, %arg1: tensor<f32>) -> tensor<20x8xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<20x8xf32>
    %0 = linalg.init_tensor [20, 8] : tensor<20x8xi1>
    ...
    %cst_1 = arith.constant dense<0.000000e+00> : tensor<f32>
    %6 = call @_where_11.135(%5, %cst_1, %arg0) : (tensor<20x8xi1>, tensor<f32>, tensor<20x8xf32>) -> tensor<20x8xf32>
    %7 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%6 : tensor<20x8xf32>) outs(%7 : tensor<20x8xf32>) {
    ^bb0(%arg2: f32, %arg3: f32):
      %12 = math.expm1 %arg2 : f32
      linalg.yield %12 : f32
    } -> tensor<20x8xf32>
    %9 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
    ...
    %11 = call @_where_12.141(%1, %arg0, %10) : (tensor<20x8xi1>, tensor<20x8xf32>, tensor<20x8xf32>) -> tensor<20x8xf32>
    return %11 : tensor<20x8xf32>
  }
  func private @_where_11.135(%arg0: tensor<20x8xi1>, %arg1: tensor<f32>, %arg2: tensor<20x8xf32>) -> tensor<20x8xf32> {
    %0 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
  ...
  func private @_where_12.141(%arg0: tensor<20x8xi1>, %arg1: tensor<20x8xf32>, %arg2: tensor<20x8xf32>) -> tensor<20x8xf32> {
    %0 = linalg.init_tensor [20, 8] : tensor<20x8xf32>
  ...
  func private @selu_13.197(%arg0: tensor<20x4xf32>) -> tensor<20x4xf32> {
    %cst = arith.constant dense<1.67326319> : tensor<f32>
    %0 = call @elu_14.184(%arg0, %cst) : (tensor<20x4xf32>, tensor<f32>) -> tensor<20x4xf32>
    %cst_0 = arith.constant dense<1.05070102> : tensor<f32>
    %cst_1 = arith.constant dense<1.05070102> : tensor<20x4xf32>
    %1 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
  ...
  func private @elu_14.184(%arg0: tensor<20x4xf32>, %arg1: tensor<f32>) -> tensor<20x4xf32> {
    %cst = arith.constant dense<0.000000e+00> : tensor<f32>
    %cst_0 = arith.constant dense<0.000000e+00> : tensor<20x4xf32>
    %0 = linalg.init_tensor [20, 4] : tensor<20x4xi1>
    ...
    %cst_1 = arith.constant dense<0.000000e+00> : tensor<f32>
    %6 = call @_where_15.173(%5, %cst_1, %arg0) : (tensor<20x4xi1>, tensor<f32>, tensor<20x4xf32>) -> tensor<20x4xf32>
    %7 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
    %8 = linalg.generic {indexing_maps = [#map1, #map1], iterator_types = ["parallel", "parallel"]} ins(%6 : tensor<20x4xf32>) outs(%7 : tensor<20x4xf32>) {
    ^bb0(%arg2: f32, %arg3: f32):
      %12 = math.expm1 %arg2 : f32
      linalg.yield %12 : f32
    } -> tensor<20x4xf32>
    %9 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
    ...
    %11 = call @_where_16.179(%1, %arg0, %10) : (tensor<20x4xi1>, tensor<20x4xf32>, tensor<20x4xf32>) -> tensor<20x4xf32>
    return %11 : tensor<20x4xf32>
  }
  func private @_where_15.173(%arg0: tensor<20x4xi1>, %arg1: tensor<f32>, %arg2: tensor<20x4xf32>) -> tensor<20x4xf32> {
    %0 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
  ...
  func private @_where_16.179(%arg0: tensor<20x4xi1>, %arg1: tensor<20x4xf32>, %arg2: tensor<20x4xf32>) -> tensor<20x4xf32> {
    %0 = linalg.init_tensor [20, 4] : tensor<20x4xf32>
  ...
  func private @_mse.215(%arg0: tensor<20x6xf32>, %arg1: tensor<20x6xf32>) -> tensor<f32> {
    %0 = linalg.init_tensor [20, 6] : tensor<20x6xf32>
    ...
    %2 = linalg.init_tensor [20, 6] : tensor<20x6xf32>
