...
module @jit__unit_scale_traindata.47 {
  func @main(%arg0: tensor<6xf32>, %arg1: tensor<i32>, %arg2: tensor<i32>) -> tensor<1x6xf32> {
    %0 = call @atleast_2d.6(%arg0) : (tensor<6xf32>) -> tensor<1x6xf32>
    %1 = call @atleast_1d.10(%arg1) : (tensor<i32>) -> tensor<1xi32>
    %2 = call @atleast_1d_0.14(%arg2) : (tensor<i32>) -> tensor<1xi32>
    ...
    %5 = call @_where_1.28(%4, %cst, %1) : (tensor<1xi1>, tensor<f32>, tensor<1xi32>) -> tensor<1xf32>
    ...
    %10 = linalg.init_tensor [1, 6] : tensor<1x6xf32>
    ...
    %12 = linalg.init_tensor [1] : tensor<1xi32>
    ...
    %14 = call @_where.20(%4, %cst_0, %13) : (tensor<1xi1>, tensor<f32>, tensor<1xi32>) -> tensor<1xf32>
  ...
  func private @atleast_2d.6(%arg0: tensor<6xf32>) -> tensor<1x6xf32> {
    %0 = tensor.expand_shape %arg0 [[0, 1]] : tensor<6xf32> into tensor<1x6xf32>
    return %0 : tensor<1x6xf32>
  }
  func private @atleast_1d.10(%arg0: tensor<i32>) -> tensor<1xi32> {
    %0 = tensor.expand_shape %arg0 [] : tensor<i32> into tensor<1xi32>
    return %0 : tensor<1xi32>
  }
  func private @atleast_1d_0.14(%arg0: tensor<i32>) -> tensor<1xi32> {
    %0 = tensor.expand_shape %arg0 [] : tensor<i32> into tensor<1xi32>
    return %0 : tensor<1xi32>
  }
  func private @_where_1.28(%arg0: tensor<1xi1>, %arg1: tensor<f32>, %arg2: tensor<1xi32>) -> tensor<1xf32> {
  ...
  func private @_where.20(%arg0: tensor<1xi1>, %arg1: tensor<f32>, %arg2: tensor<1xi32>) -> tensor<1xf32> {
    %0 = tensor.expand_shape %arg1 [] : tensor<f32> into tensor<1xf32>
    %1 = linalg.init_tensor [1] : tensor<1xf32>
    %2 = linalg.generic {indexing_maps = [#map0, #map0], iterator_types = ["parallel"]} ins(%arg2 : tensor<1xi32>) outs(%1 : tensor<1xf32>) {
    ^bb0(%arg3: i32, %arg4: f32):
