...
module @gemm attributes {gpu.container_module} {
  ...
  memref.global "private" constant @__constant_3x3xf16_0 : memref<3x3xf16> = dense<[[1.000000e+00, 2.000000e+00, 3.000000e+00], [3.000000e+00, 4.000000e+00, 5.000000e-01], [3.000000e+00, 3.000000e+00, 3.000000e+00]]>
  memref.global "private" constant @__constant_3x3xf16 : memref<3x3xf16> = dense<[[5.000000e-01, 1.999510e-01, 4.000000e+00], [1.000000e+00, 1.000000e+00, 2.000000e+00], [3.000000e+00, 3.000000e+00, 3.000490e-01]]>
  memref.global "private" constant @__constant_3x3xf32_ref_result : memref<3x3xf32> = dense<[[14.0999, 14.7998, 14.6], [11.0, 13.0, 10.5], [13.9001, 19.9001, 12.4001]]>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %0 = memref.get_global @__constant_3x3xf16 : memref<3x3xf16>
    %1 = memref.get_global @__constant_3x3xf16_0 : memref<3x3xf16>
    ...
    scf.for %arg0 = %c0 to %c100 step %c1 {
      %3 = func.call @test(%0, %1, %2) : (memref<3x3xf16>, memref<3x3xf16>, memref<3x3xf32>) -> memref<3x3xf32>
  ...
  func.func @test(%arg0: memref<3x3xf16>, %arg1: memref<3x3xf16>, %arg2: memref<3x3xf32>) -> memref<3x3xf32> attributes {llvm.emit_c_interface} {
    %c3 = arith.constant 3 : index
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %memref = gpu.alloc  host_shared () : memref<3x3xf16>
    memref.copy %arg1, %memref : memref<3x3xf16> to memref<3x3xf16>
    %memref_0 = gpu.alloc  host_shared () : memref<3x3xf16>
    memref.copy %arg0, %memref_0 : memref<3x3xf16> to memref<3x3xf16>
    %memref_1 = gpu.alloc  host_shared () : memref<3x3xf32>
    memref.copy %arg2, %memref_1 : memref<3x3xf32> to memref<3x3xf32>
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c3, %c3, %c1) threads in (%c1, %c1, %c1) args(%memref_0 : memref<3x3xf16>, %memref : memref<3x3xf16>, %memref_1 : memref<3x3xf32>, %c0 : index, %c3 : index, %c1 : index)
    gpu.dealloc  %memref_0 : memref<3x3xf16>
    gpu.dealloc  %memref : memref<3x3xf16>
    return %memref_1 : memref<3x3xf32>
  }
  spirv.module @__spv__test_kernel Physical64 OpenCL requires #spirv.vce<v1.0, [Int64, Float16, Kernel, Addresses], []> attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    ...
    spirv.func @test_kernel(%arg0: !spirv.ptr<!spirv.array<9 x f16>, CrossWorkgroup>, %arg1: !spirv.ptr<!spirv.array<9 x f16>, CrossWorkgroup>, %arg2: !spirv.ptr<!spirv.array<9 x f32>, CrossWorkgroup>, %arg3: i64, %arg4: i64, %arg5: i64) "None" attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 3, 3, 1>, workgroup_attributions = 0 : i64} {
      ...
      ^bb2:  // pred: ^bb1
        ...
        %10 = spirv.AccessChain %arg0[%9] : !spirv.ptr<!spirv.array<9 x f16>, CrossWorkgroup>, i64
        %11 = spirv.Load "CrossWorkgroup" %10 : f16
        ...
        %16 = spirv.AccessChain %arg1[%15] : !spirv.ptr<!spirv.array<9 x f16>, CrossWorkgroup>, i64
        %17 = spirv.Load "CrossWorkgroup" %16 : f16
        ...
        %22 = spirv.AccessChain %arg2[%21] : !spirv.ptr<!spirv.array<9 x f32>, CrossWorkgroup>, i64
        %23 = spirv.Load "CrossWorkgroup" %22 : f32
        %24 = spirv.FConvert %11 : f16 to f32
        %25 = spirv.FConvert %17 : f16 to f32
        ...
        %32 = spirv.AccessChain %arg2[%31] : !spirv.ptr<!spirv.array<9 x f32>, CrossWorkgroup>, i64
  ...
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%arg0: memref<3x3xf16>, %arg1: memref<3x3xf16>, %arg2: memref<3x3xf32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 3, 3, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      %0 = gpu.block_id  x
      %1 = gpu.block_id  y
      scf.for %arg6 = %arg3 to %arg4 step %arg5 {
        %2 = memref.load %arg0[%0, %arg6] : memref<3x3xf16>
        %3 = memref.load %arg1[%arg6, %1] : memref<3x3xf16>
        %4 = memref.load %arg2[%0, %1] : memref<3x3xf32>
        %5 = arith.extf %2 : f16 to f32
