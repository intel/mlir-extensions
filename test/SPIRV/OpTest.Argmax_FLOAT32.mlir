...
module @argmax attributes {gpu.container_module} {
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %0 = memref.get_global @__constant_1x4x4x3xf32 : memref<1x4x4x3xf32>
    scf.for %arg0 = %c0 to %c100 step %c1 {
      %1 = func.call @test(%0) : (memref<1x4x4x3xf32>) -> memref<i32>
  ...
  func.func @test(%arg0: memref<1x4x4x3xf32>) -> memref<i32> attributes {llvm.emit_c_interface} {
    %c1 = arith.constant 1 : index
    ...
    gpu.dealloc  %memref : memref<1x4x4x3xf32>
  ...
  spirv.module @__spv__test_kernel Physical64 OpenCL requires #spirv.vce<v1.0, [Int64, Kernel, Addresses], []> attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    spirv.func @test_kernel(%arg0: !spirv.ptr<!spirv.array<48 x f32>, CrossWorkgroup>, %arg1: i64, %arg2: !spirv.ptr<!spirv.array<1 x f32>, CrossWorkgroup>, %arg3: i64, %arg4: i64, %arg5: i64) "None" attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 1, 1, 1>, workgroup_attributions = 0 : i64} {
      spirv.mlir.loop {
  ...
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%arg0: memref<1x4x4x3xf32>, %arg1: index, %arg2: memref<f32>, %arg3: index, %arg4: index, %arg5: index) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 1, 1, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      scf.for %arg6 = %arg1 to %arg5 step %arg4 {
        scf.for %arg7 = %arg1 to %arg5 step %arg4 {
          scf.for %arg8 = %arg1 to %arg3 step %arg4 {
            %0 = memref.load %arg0[%arg1, %arg6, %arg7, %arg8] : memref<1x4x4x3xf32>
            %1 = memref.load %arg2[] : memref<f32>
            %2 = arith.cmpf ogt, %1, %0 : f32
            %3 = arith.select %2, %1, %0 : f32
            memref.store %3, %arg2[] : memref<f32>
          }
        }
      }
      gpu.return
  ...
  spirv.module @__spv__test_kernel_1 Physical64 OpenCL requires #spirv.vce<v1.0, [Int64, Kernel, Addresses], []> attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    spirv.func @test_kernel(%arg0: !spirv.ptr<!spirv.array<48 x f32>, CrossWorkgroup>, %arg1: i64, %arg2: !spirv.ptr<!spirv.array<1 x f32>, CrossWorkgroup>, %arg3: !spirv.ptr<!spirv.array<48 x i32>, CrossWorkgroup>, %arg4: !spirv.ptr<!spirv.array<1 x i32>, CrossWorkgroup>, %arg5: i32, %arg6: i64, %arg7: i64, %arg8: i64) "None" attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 1, 1, 1>, workgroup_attributions = 0 : i64} {
      spirv.mlir.loop {
        spirv.Branch ^bb1(%arg1 : i64)
      ^bb1(%0: i64):  // 2 preds: ^bb0, ^bb2
  ...
  gpu.module @test_kernel_1 attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.0, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%arg0: memref<1x4x4x3xf32>, %arg1: index, %arg2: memref<f32>, %arg3: memref<1x4x4x3xi32>, %arg4: memref<i32>, %arg5: i32, %arg6: index, %arg7: index, %arg8: index) kernel attributes {gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 1, 1, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      scf.for %arg9 = %arg1 to %arg8 step %arg7 {
        scf.for %arg10 = %arg1 to %arg8 step %arg7 {
          scf.for %arg11 = %arg1 to %arg6 step %arg7 {
            %0 = memref.load %arg0[%arg1, %arg9, %arg10, %arg11] : memref<1x4x4x3xf32>
            %1 = memref.load %arg2[] : memref<f32>
            %2 = memref.load %arg3[%arg1, %arg9, %arg10, %arg11] : memref<1x4x4x3xi32>
            %3 = memref.load %arg4[] : memref<i32>
            %4 = arith.cmpf oeq, %0, %1 : f32
