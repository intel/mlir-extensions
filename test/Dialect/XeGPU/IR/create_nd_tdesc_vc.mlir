...
func.func @test_create_nd_tdesc_vc_9(%src: memref<8x32xf32>) {
  // CHECK: xegpu.create_nd_tdesc
  // CHECK-SAME: memref<8x32xf32> -> !xegpu.tensor_desc<8x16xf32, #xegpu.tdesc_attr<memory_scope =  slm, array_length = 2 : i64>>
  %1 = xegpu.create_nd_tdesc %src[0, 0] : memref<8x32xf32> -> !xegpu.tensor_desc<8x16xf32, #xegpu.tdesc_attr<memory_scope = slm, array_length = 2>>
  return
}
