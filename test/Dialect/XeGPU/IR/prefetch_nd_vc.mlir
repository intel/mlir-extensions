...
func.func @test_prefetch_nd_tdesc_vc_0(%src: memref<24x32xf32>) {
  ...
  xegpu.prefetch_nd %1[%c0, %c1] : !xegpu.tensor_desc<8x16xf32>
...
func.func @test_prefetch_nd_tdesc_vc_i8(%src: memref<24x32xi8>) {
  ...
  %1 = xegpu.create_nd_tdesc %src : memref<24x32xi8> -> !xegpu.tensor_desc<8x16xi8>

  // CHECK: xegpu.prefetch_nd %{{.*}} : !xegpu.tensor_desc<8x16xi8>
  xegpu.prefetch_nd %1[%c0, %c1] : !xegpu.tensor_desc<8x16xi8>
...
func.func @test_prefetch_nd_tdesc_vc_bf16(%src: memref<24x32xbf16>, %x : index, %y : index) {
  ...
  xegpu.prefetch_nd %1[%x, %y] {l1_hint = #xegpu.cache_hint<uncached>, l2_hint = #xegpu.cache_hint<cached>}: !xegpu.tensor_desc<8x16xbf16>
  return
}
