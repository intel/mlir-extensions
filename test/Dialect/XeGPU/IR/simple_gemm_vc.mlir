...
func.func @test_gemm_vc_bf16(%a : memref<1024x1024xbf16>, %b: memref<1024x1024xbf16>, %c: memref<1024x1024xf32>) {
  ...
  scf.for %i= %c0 to %c1024 step %c8 {
    scf.for %j= %c0 to %c1024 step %c16 {
      ...
      %1 = xegpu.create_nd_tdesc %a : memref<1024x1024xbf16> -> !xegpu.tensor_desc<8x16xbf16>

      // CHECK: xegpu.create_nd_tdesc
      // CHECK-SAME: memref<1024x1024xbf16> -> !xegpu.tensor_desc<16x16xbf16>
      %2 = xegpu.create_nd_tdesc %b : memref<1024x1024xbf16> -> !xegpu.tensor_desc<16x16xbf16>
      ...
      %tmp0, %tmp1, %result = scf.for %k= %c0 to %c1024 step %c16
        ...
        %4 = xegpu.load_nd %subA[%i, %c0] : !xegpu.tensor_desc<8x16xbf16> -> vector<8x16xbf16>
        ...
        scf.yield %subA, %subB, %6: !xegpu.tensor_desc<8x16xbf16>, !xegpu.tensor_desc<16x16xbf16>, vector<8x16xf32>
      }

      // CHECK: xegpu.create_nd_tdesc
      // CHECK-SAME: memref<1024x1024xf32> -> !xegpu.tensor_desc<8x16xf32>
      %9 = xegpu.create_nd_tdesc %c : memref<1024x1024xf32> -> !xegpu.tensor_desc<8x16xf32>

      // CHECK: xegpu.store_nd
      // CHECK-SAME: vector<8x16xf32>, !xegpu.tensor_desc<8x16xf32>
      xegpu.store_nd %result, %9[%i, %j] : vector<8x16xf32>, !xegpu.tensor_desc<8x16xf32>
    }
  }
  return
}
