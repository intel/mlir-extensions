...
func.func @test_load_gather_vc(%src: ui64, %offsets : vector<16xindex>) {
  ...
  // CHECK-SAME: ui64, vector<16xindex>
  // CHECK-SAME: !xegpu.tensor_desc<16xf32, #xegpu.tdesc_attr<memory_scope = global, array_length = 1, boundary_check = true, #xegpu.scattered>>
  ...
  // CHECK-SAME: !xegpu.tensor_desc<16xf32, #xegpu.tdesc_attr<memory_scope = global, array_length = 1, boundary_check = true, #xegpu.scattered>>
  // CHECK-SAME: vector<16xi1> -> vector<16xf32>
...
func.func @test_load_gather_vc_2(%src: ui64, %offsets : vector<16xindex>) {
  ...
  // CHECK-SAME: ui64, vector<16xindex>
  // CHECK-SAME: !xegpu.tensor_desc<16x8xf32, #xegpu.tdesc_attr<memory_scope = global, array_length = 1, boundary_check = true, #xegpu.scattered>>
  ...
  // CHECK-SAME: !xegpu.tensor_desc<16x8xf32, #xegpu.tdesc_attr<memory_scope = global, array_length = 1, boundary_check = true, #xegpu.scattered>>
  // CHECK-SAME: vector<16x8xi1> -> vector<8x16xf32>
