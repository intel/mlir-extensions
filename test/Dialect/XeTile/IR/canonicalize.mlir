...
func.func @test_pack_unpack_chain(%source : vector<32x64xf16>) -> vector<32x64xf16> {
  %1 = xetile.tile_pack %source {inner_blocks = [16, 16]} : vector<32x64xf16> -> vector<2x4x16x16xf16>
  %2 = xetile.tile_unpack %1 {inner_blocks = [16, 16]} : vector<2x4x16x16xf16> ->  vector<32x64xf16>
...
func.func @test_unpack_pack_chain(%source : vector<2x4x16x16xf16>) -> vector<2x4x16x16xf16> {
  %1 = xetile.tile_unpack %source {inner_blocks = [16, 16]} : vector<2x4x16x16xf16> ->  vector<32x64xf16>
  %2 = xetile.tile_pack %1 {inner_blocks = [16, 16]} : vector<32x64xf16> -> vector<2x4x16x16xf16>
