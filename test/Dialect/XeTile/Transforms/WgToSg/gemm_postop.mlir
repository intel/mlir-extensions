...
#tile_attr_a = #xetile.tile_attr<wg_map = #wg_map_a, memory_space = 0>
#wg_map_b = #xetile.wg_map<sg_layout = [8, 4], sg_data = [32, 96]>
#tile_attr_b = #xetile.tile_attr<wg_map = #wg_map_b, memory_space = 0>
#wg_map_c = #xetile.wg_map<sg_layout = [8, 4], sg_data = [40, 96]>
#tile_attr_c = #xetile.tile_attr<wg_map = #wg_map_c, memory_space = 0>
...
gpu.module @test_gemm_postop  {
    ...
    -> (!xetile.tile<320x32xf16, #tile_attr_a>,
      ...
      %25 = xetile.update_tile_offset %a_tile, [%c0,  %c32] : !xetile.tile<320x32xf16, #tile_attr_a>
      %26 = xetile.update_tile_offset %b_tile, [%c32,  %c0] : !xetile.tile<32x384xf16, #tile_attr_b>
