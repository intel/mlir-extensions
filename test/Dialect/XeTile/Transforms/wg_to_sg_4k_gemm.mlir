...
gpu.module @test_wg_to_sg_4k {
    ...
    gpu.func @test_kernel(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf32>) {
        ...
        %out:3 = scf.for %k = %c0 to %c4096 step %c256
          ...
          //CHECK: %[[R29:.*]] = xetile.update_tile_offset %[[arg4]], [%[[c0]],  %[[c256]]] : !xetile.tile<64x256xf16>, index, index -> !xetile.tile<64x256xf16>
          ...
          //CHECK: %[[R30:.*]] = xetile.update_tile_offset %[[arg5]], [%[[c256]],  %[[c0]]] : !xetile.tile<256x64xf16>, index, index -> !xetile.tile<256x64xf16>
