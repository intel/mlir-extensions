...
gpu.module @test_kernel {
  gpu.func @sg_load_tile(%a: memref<32x32xf16>, %b: memref<1x32xf16>, %c: memref<32x32xf32>) {
    ...
    //CHECK: xegpu.create_nd_tdesc %arg1[%c0, %c0] : memref<1x32xf16> -> !xegpu.tensor_desc<1x32xf16, #xegpu.block_tdesc_attr<memory_space =  global, array_length = 1 : i64, boundary_check = true>>
