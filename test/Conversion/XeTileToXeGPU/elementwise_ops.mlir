// RUN: imex-opt --split-input-file --convert-xetile-to-xegpu %s -verify-diagnostics -o -| FileCheck %s
  gpu.module @test_kernel {
    ...
    gpu.func @sglevel_type_cast(%arg0: memref<1024x1024xf16>) {
      ...
      %2 = xetile.tile_unpack %1 { inner_blocks = [32, 32] }  : vector<1x1x32x32xf16> -> vector<32x32xf16>
      ...
      %7 = xetile.tile_unpack %6 { inner_blocks = [1, 16] }  : vector<32x2x1x16xf16> -> vector<32x32xf16>
      %8 = xetile.init_tile %arg0[0, 0] : memref<1024x1024xf16> -> !xetile.tile<32x32xf16, #xetile.tile_attr<inner_blocks = [8, 32]>>
      %9 = xetile.tile_pack %7 { inner_blocks = [8, 32] }  : vector<32x32xf16> -> vector<4x1x8x32xf16>
    ...
    gpu.func @sglevel_extsi_test(%arg0: memref<32x32xi16>, %arg1: memref<32x32xi32>) {
      ...
      %2 = xetile.tile_unpack %1 { inner_blocks = [32, 32] }  : vector<1x1x32x32xi16> -> vector<32x32xi16>
      %3 = xetile.tile_pack %2 { inner_blocks = [1, 16] }  : vector<32x32xi16> -> vector<32x2x1x16xi16>
      ...
      %5 = xetile.tile_unpack %4 { inner_blocks = [1, 16] }  : vector<32x2x1x16xi32> -> vector<32x32xi32>
      %6 = xetile.init_tile %arg1[0, 0] : memref<32x32xi32> -> !xetile.tile<32x32xi32, #xetile.tile_attr<inner_blocks = [8, 16]>>
      %7 = xetile.tile_pack %5 { inner_blocks = [8, 16] }  : vector<32x32xi32> -> vector<4x2x8x16xi32>
    ...
    gpu.func @sglevel_sitofp_test(%arg0: memref<32x32xi32>, %arg1: memref<32x32xf32>) {
      ...
      %2 = xetile.tile_unpack %1 { inner_blocks = [32, 16] }  : vector<1x2x32x16xi32> -> vector<32x32xi32>
      %3 = xetile.tile_pack %2 { inner_blocks = [1, 16] }  : vector<32x32xi32> -> vector<32x2x1x16xi32>
      ...
      %5 = xetile.tile_unpack %4 { inner_blocks = [1, 16] }  : vector<32x2x1x16xf32> -> vector<32x32xf32>
      %6 = xetile.init_tile %arg1[0, 0] : memref<32x32xf32> -> !xetile.tile<32x32xf32, #xetile.tile_attr<inner_blocks = [8, 16]>>
      %7 = xetile.tile_pack %5 { inner_blocks = [8, 16] }  : vector<32x32xf32> -> vector<4x2x8x16xf32>
    ...
    gpu.func @sglevel_truncf_test(%arg0: memref<32x32xf32>, %arg1: memref<32x32xf16>) {
      ...
      %2 = xetile.tile_unpack %1 { inner_blocks = [32, 16] }  : vector<1x2x32x16xf32> -> vector<32x32xf32>
      %3 = xetile.tile_pack %2 { inner_blocks = [1, 16] }  : vector<32x32xf32> -> vector<32x2x1x16xf32>
      //CHECK-COUNT-64: arith.truncf {{.*}} : vector<1x16xf32> to vector<1x16xf16>
      %4 = arith.truncf %3 : vector<32x2x1x16xf32> to vector<32x2x1x16xf16>
      %5 = xetile.tile_unpack %4 { inner_blocks = [1, 16] }  : vector<32x2x1x16xf16> -> vector<32x32xf16>
      %6 = xetile.init_tile %arg1[0, 0] : memref<32x32xf16> -> !xetile.tile<32x32xf16, #xetile.tile_attr<inner_blocks = [8, 16]>>
      %7 = xetile.tile_pack %5 { inner_blocks = [8, 16] }  : vector<32x32xf16> -> vector<4x2x8x16xf16>
    ...
    gpu.func @sglevel_trunci_test(%arg0: memref<32x32xi32>, %arg1: memref<32x32xi16>) {
      ...
      %5 = xetile.tile_unpack %4 { inner_blocks = [1, 16] }  : vector<32x2x1x16xi16> -> vector<32x32xi16>
      %6 = xetile.init_tile %arg1[0, 0] : memref<32x32xi16> -> !xetile.tile<32x32xi16, #xetile.tile_attr<inner_blocks = [8, 16]>>
      %7 = xetile.tile_pack %5 { inner_blocks = [8, 16] }  : vector<32x32xi16> -> vector<4x2x8x16xi16>
