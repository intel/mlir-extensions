...
gpu.module @test_kernel {
  ...
  gpu.func @sglevel_tiled_gemm(%a: memref<1024x1024xf16>, %b: memref<1024x1024xf16>) {
    ...
    //CHECK: %[[r1:.*]]:2 = scf.for %[[arg2:.*]] = %[[c0]] to %[[c1024]] step %[[c64]] iter_args(%[[arg3:.*]] = %[[r0]], %[[arg4:.*]] = %[[cst]]) -> (!xegpu.tensor_desc<32x32xf16>, vector<32x32xf16>) {
    %nexta, %res = scf.for %k= %c0 to %c1024 step %c64 iter_args(%subA = %1, %subB = %cst) -> (!xetile.tile<32x32xf16>, vector<32x32xf16>) {

      //CHECK: %[[r10:.*]] = xegpu.load_nd %[[arg3]] {mode = vc, l1_hint = cached, l2_hint = cached, l3_hint = cached} : !xegpu.tensor_desc<32x32xf16> -> vector<32x32xf16>
      %3 = xetile.load_tile %subA : !xetile.tile<32x32xf16> -> vector<32x32xf16>

      //CHECK: %[[r11:.*]] = xegpu.update_nd_offset %[[arg3]], [%[[c0]], %[[c64]]] {mode = vc} : !xegpu.tensor_desc<32x32xf16> -> !xegpu.tensor_desc<32x32xf16>
      %5 = xetile.update_tile_offset %subA, [%c0, %c64]: !xetile.tile<32x32xf16>, index, index -> !xetile.tile<32x32xf16>

      //CHECK: scf.yield %[[r11]], %[[r10]] : !xegpu.tensor_desc<32x32xf16>, vector<32x32xf16>
    ...
    //CHECK: %[[r6:.*]] = xegpu.create_nd_tdesc %[[arg1]][%[[c0]], %[[c64]]] {mode = vc} : memref<1024x1024xf16> -> !xegpu.tensor_desc<8x32xf16>
    //CHECK: %[[c8:.*]] = arith.constant 8 : index
    //CHECK: %[[r7:.*]] = xegpu.create_nd_tdesc %[[arg1]][%[[c8]], %[[c64]]] {mode = vc} : memref<1024x1024xf16> -> !xegpu.tensor_desc<8x32xf16>
    //CHECK: %[[c16:.*]] = arith.constant 16 : index
    //CHECK: %[[r8:.*]] = xegpu.create_nd_tdesc %[[arg1]][%[[c16]], %[[c64]]] {mode = vc} : memref<1024x1024xf16> -> !xegpu.tensor_desc<8x32xf16>
    //CHECK: %[[c24:.*]] = arith.constant 24 : index
    //CHECK: %[[r9:.*]] = xegpu.create_nd_tdesc %[[arg1]][%[[c24]], %[[c64]]] {mode = vc} : memref<1024x1024xf16> -> !xegpu.tensor_desc<8x32xf16>
  	%5 = xetile.init_tile %b[%c0, %c64] : memref<1024x1024xf16> -> !xetile.tile<32x32xf16>

    //CHECK: xegpu.store_nd %[[r2]], %[[r6]] {mode = vc, l1_hint = write_back, l2_hint = write_back, l3_hint = write_back} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
    //CHECK: xegpu.store_nd %[[r3]], %[[r7]] {mode = vc, l1_hint = write_back, l2_hint = write_back, l3_hint = write_back} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
    //CHECK: xegpu.store_nd %[[r4]], %[[r8]] {mode = vc, l1_hint = write_back, l2_hint = write_back, l3_hint = write_back} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
    //CHECK: xegpu.store_nd %[[r5]], %[[r9]] {mode = vc, l1_hint = write_back, l2_hint = write_back, l3_hint = write_back} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
