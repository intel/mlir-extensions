...
gpu.module @test_kernel {
  ...
  gpu.func @copy_via_slm(%A: memref<64x64xf16>, %B: memref<64x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
    ...
    //CHECK: %[[r2:.*]] = xegpu.create_nd_tdesc %[[arg0]][%[[r0]], %[[r1]]] : memref<64x64xf16> -> !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 1 : i64, boundary_check = true>>
    //CHECK: %[[r3:.*]] = xegpu.load_nd %[[r2]] <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>}> : !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 1 : i64, boundary_check = true>> -> vector<8x16xf16>
  ...
  gpu.func @transpose_via_slm(%A: memref<64x64xf16>, %B: memref<64x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
    ...
    %a_tile = xetile.init_tile %A[%m, %n] : memref<64x64xf16> -> !xetile.tile<8x16xf16>
    //CHECK: %[[r3:.*]] = xegpu.load_nd {{.*}}: !xegpu.tensor_desc<8x16xf16, #xegpu.block_tdesc_attr<array_length = 1 : i64, boundary_check = true>> -> vector<4x16x2xf16>
    %a = xetile.load_tile %a_tile : !xetile.tile<8x16xf16> -> vector<8x16xf16>
