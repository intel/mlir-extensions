...
// CHECK-NEXT: [[valloc:%.*]] = memref.alloc([[vdim]]) alignment = 8 : memref<?xi64>
...
// CHECK-NEXT: [[valloc_2:%.*]] = memref.alloc([[vdim_1]]) alignment = 8 : memref<?xi64>
...
// CHECK-NEXT: [[valloc_5:%.*]] = memref.alloc([[vdim_4]]) alignment = 8 : memref<?xi64>
