// RUN: IMEX_USE_IGC_VECTOR_BACK_END=1 %python_executable %imex_runner --requires=l0-runtime -i %s --pass-pipeline-file=%p/xegpu-to-func-vc.pp \
// RUN:                                       --runner imex-cpu-runner -e main \
// RUN:                                       --entry-point-result=void \
// RUN:                                       --shared-libs=%irunner_utils,%mlir_runner_utils,%mlir_c_runner_utils,%levelzero_runtime --filecheck
// RUN: IMEX_USE_IGC_VECTOR_BACK_END=1 %python_executable %imex_runner --requires=sycl-runtime -i %s --pass-pipeline-file=%p/xegpu-to-func-vc.pp \
// RUN:                                        --runner imex-cpu-runner -e main \
// RUN:                                        --entry-point-result=void \
...
module @gemm attributes {gpu.container_module} {
  ...
  func.func @test(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    %c64 = arith.constant 64 : index
    %c128 = arith.constant 128 : index
    %c1 = arith.constant 1 : index
    %memref = gpu.alloc  host_shared () : memref<1024x1024xbf16>
    memref.copy %arg0, %memref : memref<1024x1024xbf16> to memref<1024x1024xbf16>
    %memref_0 = gpu.alloc  host_shared () : memref<1024x1024xbf16>
    memref.copy %arg1, %memref_0 : memref<1024x1024xbf16> to memref<1024x1024xbf16>
    %memref_1 = gpu.alloc  host_shared () : memref<1024x1024xf32>
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c128, %c64, %c1) threads in (%c1, %c1, %c1) args(%memref : memref<1024x1024xbf16>, %memref_0 : memref<1024x1024xbf16>, %memref_1 : memref<1024x1024xf32>)
    gpu.dealloc  %memref : memref<1024x1024xbf16>
    gpu.dealloc  %memref_0 : memref<1024x1024xbf16>
    return %memref_1 : memref<1024x1024xf32>
  }
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL, Bfloat16ConversionINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 128, 64, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %6 = scf.for %arg3 = %c0 to %c1024 step %c16 iter_args(%arg4 = %5) -> (vector<8x16xf32>) {
        ...
        %10 = xegpu.load_nd %8 {packed} : !xegpu.tensor_desc<16x16xbf16> -> vector<8x16x2xbf16>
        %11 = xegpu.dpas %9, %10, %arg4 : vector<8x16xbf16>, vector<8x16x2xbf16>, vector<8x16xf32> -> vector<8x16xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    %0 = memref.get_global @__constant_1024x1024xbf16 : memref<1024x1024xbf16>
    %1 = memref.get_global @__constant_1024x1024xbf16_ : memref<1024x1024xbf16>
    %ref = memref.get_global @__constant_1024x1024xf32 : memref<1024x1024xf32>
    %init = arith.constant 0.0 : bf16
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c8 = arith.constant 8 : index
    %c16 = arith.constant 16 : index
    ...
    scf.for %arg0 = %c0 to %c128 step %c1 {
      scf.for %arg1 = %c0 to %c128 step %c1 {
        ...
        %fp = arith.uitofp %idx1 : i16 to bf16
        %cst100 = arith.constant 100.0 : bf16
        %val0 = arith.divf %fp, %cst100 : bf16
        %cst1 = arith.constant 1.0 : bf16
        %val1 = arith.addf %val0, %cst1 : bf16
        memref.store %val0, %0[%arg0, %arg1] : memref<1024x1024xbf16>
        memref.store %val1, %1[%arg0, %arg1] : memref<1024x1024xbf16>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        %res = scf.for %arg2 = %c0 to %c1024 step %c1 iter_args(%arg3 = %acc) -> f32 {
          %a = memref.load %0[%arg0, %arg2] : memref<1024x1024xbf16>
          %b = memref.load %1[%arg2, %arg1] : memref<1024x1024xbf16>
          %c = arith.mulf %a, %b : bf16
          %cc = arith.extf %c : bf16 to f32
    ...
    %2 = call @test(%0, %1) : (memref<1024x1024xbf16>, memref<1024x1024xbf16>) -> memref<1024x1024xf32>
