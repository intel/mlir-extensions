...
#a = #xegpu.layout<sg_layout = [8, 8], sg_data = [32, 64], inst_data = [8, 16]>
#b = #xegpu.layout<sg_layout = [8, 8], sg_data = [64, 32], inst_data = [16, 16]>
#c = #xegpu.layout<sg_layout = [8, 8], sg_data = [32, 32], inst_data = [8, 16]>
#a_load = #xegpu.layout<sg_layout = [8, 8], sg_data = [32, 64], inst_data = [32, 16]>
#b_load = #xegpu.layout<sg_layout = [8, 8], sg_data = [64, 32], inst_data = [32, 16]>
#a_prefetch = #xegpu.layout<sg_layout = [32, 1], sg_data = [8, 32], inst_data = [8, 16]>
#b_prefetch = #xegpu.layout<sg_layout = [8, 8], sg_data = [8, 32], inst_data = [8, 16]>
module @gemm attributes {gpu.container_module} {
  func.func @test(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf32>, %bias: memref<4096xf32>) -> f64 attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c16, %c16, %c1) threads in (%c1024, %c1, %c1) args(%bias_gpu : memref<4096xf32>, %C_gpu : memref<4096x4096xf32>, %A_gpu : memref<4096x4096xf16>, %B_gpu : memref<4096x4096xf16>)
    gpu.wait
  ...
  gpu.module @test_kernel {
    gpu.func @test_kernel(%arg0: memref<4096xf32>, %arg1: memref<4096x4096xf32>, %arg2: memref<4096x4096xf16>, %arg3: memref<4096x4096xf16>) kernel attributes {known_block_size = array<i32: 1024, 1, 1>, known_grid_size = array<i32: 16, 16, 1>} {
      ...
      %8 = xegpu.create_nd_tdesc %arg1 : memref<4096x4096xf32> -> !xegpu.tensor_desc<256x256xf32, #xegpu.block_tdesc_attr<boundary_check = false>>
      %9 = xegpu.load_nd %8[%0, %1]  : !xegpu.tensor_desc<256x256xf32, #xegpu.block_tdesc_attr<boundary_check = false>> -> vector<256x256xf32>
      %10 = xegpu.create_nd_tdesc %arg2 : memref<4096x4096xf16> -> !xegpu.tensor_desc<256x64xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
      xegpu.prefetch_nd %10[%0, %c0] <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>, layout = #a_prefetch}> : !xegpu.tensor_desc<256x64xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
      %11 = xegpu.create_nd_tdesc %arg3 : memref<4096x4096xf16> -> !xegpu.tensor_desc<64x256xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
      xegpu.prefetch_nd %11[%c0, %1] <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>, layout = #b_prefetch}> : !xegpu.tensor_desc<64x256xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
      %12 = scf.for %arg4 = %c0 to %c4096 step %c64 iter_args(%arg5 = %9) -> (vector<256x256xf32>) {
        %14 = arith.addi %arg4, %c64 : index
        xegpu.prefetch_nd %11[%14, %1] <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>, layout = #b_prefetch}> : !xegpu.tensor_desc<64x256xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
        xegpu.prefetch_nd %10[%0, %14] <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<cached>, l3_hint = #xegpu.cache_hint<cached>, layout = #a_prefetch}> : !xegpu.tensor_desc<256x64xf16, #xegpu.block_tdesc_attr<boundary_check = false>>
        %15 = xegpu.load_nd %10[%0, %arg4] <{layout = #a_load}> : !xegpu.tensor_desc<256x64xf16, #xegpu.block_tdesc_attr<boundary_check = false>> -> vector<256x64xf16>
        %16 = xegpu.load_nd %11[%arg4, %1] <{layout = #b_load}> : !xegpu.tensor_desc<64x256xf16, #xegpu.block_tdesc_attr<boundary_check = false>> -> vector<64x256xf16>
        %17 = xegpu.convert_layout %15 <{input_layout = #a_load, target_layout = #a}> : vector<256x64xf16>
        %18 = xegpu.convert_layout %16 <{input_layout = #b_load, target_layout = #b}> : vector<64x256xf16>
        %19 = xegpu.dpas %17, %18, %arg5 {layout_a = #a, layout_b = #b, layout_cd = #c} : vector<256x64xf16>, vector<64x256xf16>, vector<256x256xf32> -> vector<256x256xf32>
        scf.yield %19 : vector<256x256xf32>
      }
      %13 = arith.addf %7, %12 : vector<256x256xf32>
      xegpu.store_nd %13, %8[%0, %1] <{layout = #c}> : vector<256x256xf32>, !xegpu.tensor_desc<256x256xf32, #xegpu.block_tdesc_attr<boundary_check = false>>
      gpu.return
    }
  }
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    // Initialize matrix A with random values in (-0.5, 0.5).
