...
#data_layout_leading_unit_dim = #xegpu.layout<sg_layout = [1, 4, 4], sg_data = [1, 64, 64]>
module attributes {gpu.container_module} {
  gpu.module @reduction {
    gpu.func @cross_sg_sub_size_cross_lane_3D_1D(%src: memref<?xf32, 1>, %dst: memref<256xf32, 1>) kernel {
  ...
  func.func @test(%src : memref<65536xf32>, %dst : memref<256xf32>) attributes {llvm.emit_c_interface} {
    ...
    %stream0_5 = gpu.launch_func async[%stream0_4] @reduction::@cross_sg_sub_size_cross_lane_3D_1D blocks in (%c1, %c1, %c1) threads in (%c1024, %c1, %c1) args(%gpu_memref_src_casted : memref<?xf32, 1>, %gpu_memref_dst_casted : memref<256xf32, 1>)
