...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%A: memref<4096x4096xf16>, %B: memref<4096x4096xf16>, %C: memref<4096x4096xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %c_sg_tile_00 = xegpu.create_nd_tdesc %C[%C_sg_tile_offset_x, %C_sg_tile_offset_y] {mode = vc}: memref<4096x4096xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_0_0, %c_sg_tile_00 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_01 = xegpu.update_nd_offset %c_sg_tile_00, [%c0, %c32]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_0_1, %c_sg_tile_01 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_10 = xegpu.update_nd_offset %c_sg_tile_00, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_1_0, %c_sg_tile_10 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_11 = xegpu.update_nd_offset %c_sg_tile_01, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_1_1, %c_sg_tile_11 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_20 = xegpu.update_nd_offset %c_sg_tile_10, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_2_0, %c_sg_tile_20 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_21 = xegpu.update_nd_offset %c_sg_tile_11, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_2_1, %c_sg_tile_21 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_30 = xegpu.update_nd_offset %c_sg_tile_20, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_3_0, %c_sg_tile_30 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
      xegpu.compile_hint
      ...
      %c_sg_tile_31 = xegpu.update_nd_offset %c_sg_tile_21, [%c8, %c0]  {mode = vc}: !xegpu.tensor_desc<8x32xf16> -> !xegpu.tensor_desc<8x32xf16>
      xegpu.store_nd %c_result_8x32_3_1, %c_sg_tile_31 {l1_hint = write_back, l2_hint = write_back, l3_hint = write_back, mode=vc} : vector<8x32xf16>, !xegpu.tensor_desc<8x32xf16>
