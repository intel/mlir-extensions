...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel  {
    ...
    gpu.func @test_transpose(%arg0: memref<16x32xf16>, %arg1: memref<8x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %3 = xegpu.load_nd %2 <{packed}> : !xegpu.tensor_desc<16x8xf16> -> vector<8x8x2xf16>
      %4 = vector.shape_cast %3 : vector<8x8x2xf16> to vector<128xf16>
      %5 = vector.bitcast %4 : vector<128xf16> to vector<64xf32>
      %6 = vector.shape_cast %5 : vector<64xf32> to vector<8x8xf32>
      %cst = arith.constant dense<0.000000e+00> : vector<8x8xf32>
      %7 = vector.shuffle %6, %cst [0, 8, 1, 9, 2, 10, 3, 11, 4, 12, 5, 13, 6, 14, 7, 15] : vector<8x8xf32>, vector<8x8xf32>
      %8 = vector.shape_cast %7 : vector<16x8xf32> to vector<8x16xf32>
      ...
      %9 = arith.muli %0, %c64 : index
      %10 = vector.broadcast %9 : index to vector<16xindex>
      %cst_1 = arith.constant dense<[0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96, 104, 112, 120]> : vector<16xindex>
      %11 = arith.addi %10, %cst_1 : vector<16xindex>
      %12 = xegpu.create_tdesc %alloc, %11 : memref<256xf32, 3>, vector<16xindex> -> !xegpu.tensor_desc<16x8xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 8 : i64>>
      %13 = vector.transpose %8, [1, 0] : vector<8x16xf32> to vector<16x8xf32>
      xegpu.store %13, %12, %cst_0  : vector<16x8xf32>, !xegpu.tensor_desc<16x8xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 8 : i64>>, vector<16xi1>
      %14 = arith.muli %0, %c64 : index
      %15 = xegpu.create_nd_tdesc %alloc[%14] : memref<256xf32, 3> -> !xegpu.tensor_desc<64xf32, #xegpu.block_tdesc_attr<memory_space =  slm>>
      %16 = xegpu.load_nd %15  : !xegpu.tensor_desc<64xf32, #xegpu.block_tdesc_attr<memory_space =  slm>> -> vector<64xf32>
      %17 = vector.bitcast %16 : vector<64xf32> to vector<128xf16>
      %18 = vector.shape_cast %17 : vector<128xf16> to vector<8x16xf16>
      %19 = arith.muli %0, %c16 : index
      %20 = xegpu.create_nd_tdesc %arg1[0, %19] : memref<8x64xf16> -> !xegpu.tensor_desc<8x16xf16>
      xegpu.store_nd %18, %20  : vector<8x16xf16>, !xegpu.tensor_desc<8x16xf16>
      gpu.return
    }
  }
