...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    ...
    gpu.func @test_transpose(%arg0: memref<16x32xf16>, %arg1: memref<8x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %cast = vector.shape_cast %data32b : vector<64xf32> to vector<8x8xf32>
      ...
      %baseVec = vector.broadcast %base : index to vector<8xindex>
      %staticOff = arith.constant dense<[0, 8, 16, 24, 32, 40, 48, 56]> : vector<8xindex>
      %offsets = arith.addi %baseVec, %staticOff : vector<8xindex>
      %slm_desc = xegpu.create_tdesc %slm, %offsets : memref<256xf32, 3>, vector<8xindex> -> !xegpu.tensor_desc<8x8xf32, #slm>

      %mask = arith.constant dense<[1, 1, 1, 1, 1, 1, 1, 1]> : vector<8xi1>
      %trans = vector.transpose %cast, [1, 0] : vector<8x8xf32> to vector<8x8xf32>
      xegpu.store %trans, %slm_desc, %mask : vector<8x8xf32>, !xegpu.tensor_desc<8x8xf32, #slm>, vector<8xi1>
