...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel  {
    ...
    gpu.func @test_transpose(%arg0: memref<16x32xf16>, %arg1: memref<8x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %8 = vector.broadcast %7 : index to vector<8xindex>
      %cst = arith.constant dense<[0, 8, 16, 24, 32, 40, 48, 56]> : vector<8xindex>
      %9 = arith.addi %8, %cst : vector<8xindex>
      %10 = xegpu.create_tdesc %alloc, %9 : memref<256xf32, 3>, vector<8xindex> -> !xegpu.tensor_desc<8x8xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 8 : i64>>
      %cst_0 = arith.constant dense<true> : vector<8xi1>
      %11 = vector.transpose %6, [1, 0] : vector<8x8xf32> to vector<8x8xf32>
      xegpu.store %11, %10, %cst_0  : vector<8x8xf32>, !xegpu.tensor_desc<8x8xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 8 : i64>>, vector<8xi1>
      %12 = arith.muli %0, %c64 : index
      %13 = xegpu.create_nd_tdesc %alloc[%12] : memref<256xf32, 3> -> !xegpu.tensor_desc<64xf32, #xegpu.block_tdesc_attr<memory_space =  slm>>
      %14 = xegpu.load_nd %13  : !xegpu.tensor_desc<64xf32, #xegpu.block_tdesc_attr<memory_space =  slm>> -> vector<64xf32>
      %15 = vector.bitcast %14 : vector<64xf32> to vector<128xf16>
      %16 = vector.shape_cast %15 : vector<128xf16> to vector<8x16xf16>
      %17 = arith.muli %0, %c16 : index
      %18 = xegpu.create_nd_tdesc %arg1[0, %17] : memref<8x64xf16> -> !xegpu.tensor_desc<8x16xf16>
      xegpu.store_nd %16, %18  : vector<8x16xf16>, !xegpu.tensor_desc<8x16xf16>
      gpu.return
    }
  }
