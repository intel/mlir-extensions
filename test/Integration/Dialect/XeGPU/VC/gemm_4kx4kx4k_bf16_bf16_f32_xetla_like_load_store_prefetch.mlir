...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel  {
    ...
    gpu.func @test_kernel(%arg0: memref<4096x4096xbf16>, %arg1: memref<4096x4096xbf16>, %arg2: memref<4096x4096xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %10 = xegpu.create_nd_tdesc %arg0[%9, %c0] : memref<4096x4096xbf16> -> !xegpu.tensor_desc<8x32xbf16>
      ...
      %21 = xegpu.create_nd_tdesc %arg1[%15, %20] : memref<4096x4096xbf16> -> !xegpu.tensor_desc<8x32xbf16>
      ...
      %25 = xegpu.create_nd_tdesc %arg0[%2, %c0] : memref<4096x4096xbf16> -> !xegpu.tensor_desc<16x16xbf16, #xegpu.block_tdesc_attr<array_length = 2 : i64>>
      %26 = xegpu.update_nd_offset %25, [%c16, %c0] : !xegpu.tensor_desc<16x16xbf16, #xegpu.block_tdesc_attr<array_length = 2 : i64>>
      %27 = xegpu.create_nd_tdesc %arg1[%c0, %3] : memref<4096x4096xbf16> -> !xegpu.tensor_desc<16x16xbf16, #xegpu.block_tdesc_attr<array_length = 2 : i64>>
      ...
      %54 = xegpu.create_nd_tdesc %arg2[%2, %3] : memref<4096x4096xf32> -> !xegpu.tensor_desc<8x16xf32>
