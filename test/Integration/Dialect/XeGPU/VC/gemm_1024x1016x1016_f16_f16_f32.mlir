...
module @gemm attributes {gpu.container_module} {
  memref.global "private" @__constant_1024x1016xf16 : memref<1024x1016xf16> = dense<1.000000e+00>
  memref.global "private" @__constant_1016x1016xf16_ : memref<1016x1016xf16> = dense<1.000000e+00>
  memref.global "private" @__constant_1024x1016xf32 : memref<1024x1016xf32> = dense<0.000000e+00>
  func.func @test(%arg0: memref<1024x1016xf16>, %arg1: memref<1016x1016xf16>) -> memref<1024x1016xf32> attributes {llvm.emit_c_interface} {
    ...
    %memref = gpu.alloc  () : memref<1024x1016xf16>
    gpu.memcpy  %memref, %arg0 : memref<1024x1016xf16>, memref<1024x1016xf16>
    %memref_0 = gpu.alloc  () : memref<1016x1016xf16>
    gpu.memcpy  %memref_0, %arg1 : memref<1016x1016xf16>, memref<1016x1016xf16>
    %memref_1 = gpu.alloc  () : memref<1024x1016xf32>
    ...
    %alloc = memref.alloc() : memref<1024x1016xf32>
    gpu.memcpy  %alloc, %memref_1 : memref<1024x1016xf32>, memref<1024x1016xf32>
    gpu.dealloc  %memref_1 : memref<1024x1016xf32>
    return %alloc : memref<1024x1016xf32>
  }
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1016xf16>, %arg1: memref<1016x1016xf16>, %arg2: memref<1024x1016xf32>) kernel attributes {VectorComputeFunctionINTEL, gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 128, 64, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %2 = xegpu.create_nd_tdesc %arg2[%0, %1] : memref<1024x1016xf32> -> !xegpu.tensor_desc<8x16xf32>
      %3 = xegpu.load_nd %2  : !xegpu.tensor_desc<8x16xf32> -> vector<8x16xf32>
      %4 = scf.for %arg3 = %c0 to %c1016 step %c16 iter_args(%arg4 = %3) -> (vector<8x16xf32>) {
        %5 = xegpu.create_nd_tdesc %arg0[%0, %arg3] : memref<1024x1016xf16> -> !xegpu.tensor_desc<8x16xf16>
        %6 = xegpu.create_nd_tdesc %arg1[%arg3, %1] : memref<1016x1016xf16> -> !xegpu.tensor_desc<16x16xf16>
        %7 = xegpu.load_nd %5  : !xegpu.tensor_desc<8x16xf16> -> vector<8x16xf16>
        %8 = xegpu.load_nd %6 <{packed}> : !xegpu.tensor_desc<16x16xf16> -> vector<8x16x2xf16>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %2 = memref.get_global @__constant_1024x1016xf32 : memref<1024x1016xf32>
    scf.for %arg0 = %c0 to %c128 step %c1 {
      scf.for %arg1 = %c0 to %c128 step %c1 {
        ...
        memref.store %9, %0[%arg0, %arg1] : memref<1024x1016xf16>
        memref.store %10, %1[%arg0, %arg1] : memref<1016x1016xf16>
      }
    }
    // caculate the result C matrix
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1016 step %c1 {
        %4 = memref.load %2[%arg0, %arg1] : memref<1024x1016xf32>
        %5 = scf.for %arg2 = %c0 to %c1016 step %c1 iter_args(%arg3 = %4) -> (f32) {
          %6 = memref.load %0[%arg0, %arg2] : memref<1024x1016xf16>
          %7 = memref.load %1[%arg2, %arg1] : memref<1016x1016xf16>
          %8 = arith.mulf %6, %7 : f16
          %9 = arith.extf %8 : f16 to f32
          %10 = arith.addf %9, %arg3 : f32
          scf.yield %10 : f32
        }
        memref.store %5, %2[%arg0, %arg1] : memref<1024x1016xf32>
      }
    }
    // call @printMemrefF32(%cast) : (memref<*xf32>) -> ()
    // call @printMemrefF32(%cast_ref) : (memref<*xf32>) -> ()
    // CHECK:   [ALLCLOSE: TRUE]
    %3 = call @test(%0, %1) : (memref<1024x1016xf16>, memref<1016x1016xf16>) -> memref<1024x1016xf32>
    %cast = memref.cast %3 : memref<1024x1016xf32> to memref<*xf32>
    %cast_1 = memref.cast %2 : memref<1024x1016xf32> to memref<*xf32>
