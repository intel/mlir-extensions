...
module @gemm attributes {gpu.container_module} {
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    // Run CPU
    %A_cast = memref.cast %A : memref<256x256xbf16> to memref<*xbf16>
    %B_cast = memref.cast %B : memref<256x256xbf16> to memref<*xbf16>
    %C_ref_cast = memref.cast %C_ref : memref<256x256xf32> to memref<*xf32>
    call @gemmBF16BF16F32(%A_cast, %B_cast, %C_ref_cast) : (memref<*xbf16>, memref<*xbf16>, memref<*xf32>) -> ()
