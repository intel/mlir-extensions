...
module @softmax attributes {gpu.container_module} {
  ...
  gpu.module @kernel  {
    gpu.func @reduce_dim_1(%arg0: memref<16x512xf32>, %arg1: memref<512xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %4 = vector.multi_reduction <add>, %3, %cst [1] : vector<16x16xf32> to vector<16xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg0 = %c0 to %c512 step %c16 {
      scf.for %arg1 = %c0 to %c16 step %c1 {
        %1 = scf.for %arg2 = %c0 to %c16 step %c1 iter_args(%arg3 = %cst) -> (f32) {
          %3 = arith.addi %arg0, %arg2 : index
          %4 = memref.load %alloc[%arg1, %3] : memref<16x512xf32>
          %5 = arith.addf %arg3, %4 : f32
          scf.yield %5 : f32
        }
        %2 = arith.addi %arg0, %arg1 : index
        memref.store %1, %alloc_1[%2] : memref<512xf32>
      }
    }
