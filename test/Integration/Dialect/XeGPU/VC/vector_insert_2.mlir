...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @module0  {
    gpu.func @test_kernel(%arg0: memref<8x16xf32>, %arg1: memref<8x16xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %cst = arith.constant dense<1.230000e+00> : vector<16xf32>
      %2 = vector.insert %cst, %1 [7] : vector<16xf32> into vector<8x16xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    // run GPU version
    // run CPU version
    %cst = arith.constant 1.230000e+00 : f32
    ...
    call @fillResource1DRandomF32(%cast, %cst_0, %cst_1, %false) : (memref<*xf32>, f32, f32, i1) -> ()
    ...
    scf.for %arg0 = %c0 to %c8 step %c1 {
      scf.for %arg1 = %c0 to %c16 step %c1 {
        ...
        memref.store %1, %alloc_2[%arg0, %arg1] : memref<8x16xf32>
      }
    }
    scf.for %arg0 = %c0 to %c16 step %c1 {
      memref.store %cst, %alloc_2[%c7, %arg0] : memref<8x16xf32>
    }
    ...
    // dealloc
    // gpu dealloc
    %cast_4 = memref.cast %alloc_2 : memref<8x16xf32> to memref<*xf32>
    call @printAllcloseF32(%cast_3, %cast_4) : (memref<*xf32>, memref<*xf32>) -> ()
    memref.dealloc %alloc : memref<8x16xf32>
    memref.dealloc %alloc_2 : memref<8x16xf32>
