...
module @gemm attributes {gpu.container_module} {
  memref.global "private" @__constant_1024x1024xbf16 : memref<1024x1024xbf16> = dense<0.000000e+00>
  memref.global "private" @__constant_1024x1024xbf16_ : memref<1024x1024xbf16> = dense<0.000000e+00>
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 128, 64, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %4 = scf.for %arg3 = %c0 to %c1024 step %c16 iter_args(%arg4 = %3) -> (vector<8x16xf32>) {
        %5 = xegpu.create_nd_tdesc %arg0[%0, %arg3] : memref<1024x1024xbf16> -> !xegpu.tensor_desc<8x16xbf16>
        %6 = xegpu.create_nd_tdesc %arg1[%arg3, %1] : memref<1024x1024xbf16> -> !xegpu.tensor_desc<16x16xbf16>
        %7 = xegpu.load_nd %5  : !xegpu.tensor_desc<8x16xbf16> -> vector<8x16xbf16>
        %8 = xegpu.load_nd %6 <{packed}> : !xegpu.tensor_desc<16x16xbf16> -> vector<8x16x2xbf16>
        %9 = xegpu.dpas %7, %8, %arg4 : vector<8x16xbf16>, vector<8x16x2xbf16>, vector<8x16xf32> -> vector<8x16xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %cst_0 = arith.constant 1.000000e+02 : bf16
    ...
    scf.for %arg0 = %c0 to %c128 step %c1 {
      scf.for %arg1 = %c0 to %c128 step %c1 {
        ...
        %8 = arith.uitofp %7 : i16 to bf16
        %9 = arith.divf %8, %cst_0 : bf16
        %10 = arith.addf %9, %cst : bf16
        memref.store %9, %0[%arg0, %arg1] : memref<1024x1024xbf16>
        memref.store %10, %1[%arg0, %arg1] : memref<1024x1024xbf16>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        %5 = scf.for %arg2 = %c0 to %c1024 step %c1 iter_args(%arg3 = %4) -> (f32) {
          %6 = memref.load %0[%arg0, %arg2] : memref<1024x1024xbf16>
          %7 = memref.load %1[%arg2, %arg1] : memref<1024x1024xbf16>
    ...
    // CHECK:   [ALLCLOSE: TRUE]
    %3 = call @test(%0, %1) : (memref<1024x1024xbf16>, memref<1024x1024xbf16>) -> memref<1024x1024xf32>
