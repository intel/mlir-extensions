...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<8x16xf32>) -> memref<8x16xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c1, %c1, %c1) threads in (%c1, %c1, %c1)  args(%cast : memref<?x?xf32>, %cast_1 : memref<?x?xf32>)
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<?x?xf32>, %arg1: memref<?x?xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %0 = xegpu.create_nd_tdesc %arg0[0, 0], shape : [%c8, %c16], strides : [%c16, %c1] : memref<?x?xf32> -> !xegpu.tensor_desc<8x16xf32>
      ...
      %2 = xegpu.create_nd_tdesc %arg1[0, 0], shape : [%c8, %c16], strides : [%c16, %c1] : memref<?x?xf32> -> !xegpu.tensor_desc<8x16xf32>
