...
module @transpose attributes {gpu.container_module} {
  func.func @test(%arg0: memref<32x32xf32>) -> memref<32x32xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c4, %c4, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<32x32xf32>, %memref_0 : memref<32x32xf32>)
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<32x32xf32>, %arg1: memref<32x32xf32>) kernel attributes {VectorComputeFunctionINTEL, gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 4, 4, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %2 = xegpu.create_nd_tdesc %arg0[%0, %1] : memref<32x32xf32> -> !xegpu.tensor_desc<8x8xf32>
      %3 = xegpu.load_nd %2  : !xegpu.tensor_desc<8x8xf32> -> vector<8x8xf32>
      %4 = xegpu.create_nd_tdesc %arg1[%1, %0] : memref<32x32xf32> -> !xegpu.tensor_desc<8x8xf32>
      %5 = vector.transpose %3, [1, 0] : vector<8x8xf32> to vector<8x8xf32>
      xegpu.store_nd %5, %4  : vector<8x8xf32>, !xegpu.tensor_desc<8x8xf32>
      gpu.return
    }
  }
