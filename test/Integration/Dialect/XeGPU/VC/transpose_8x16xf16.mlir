...
module @transpose attributes {gpu.container_module} {
  func.func @test(%arg0: memref<32x32xf16>) -> memref<32x32xf16> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c4, %c2, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<32x32xf16>, %memref_0 : memref<32x32xf16>)
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<32x32xf16>, %arg1: memref<32x32xf16>) kernel attributes {VectorComputeFunctionINTEL, gpu.known_block_size = array<i32: 1, 1, 1>, gpu.known_grid_size = array<i32: 4, 2, 1>, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %2 = xegpu.create_nd_tdesc %arg0[%0, %1] : memref<32x32xf16> -> !xegpu.tensor_desc<8x16xf16>
      %3 = xegpu.load_nd %2  : !xegpu.tensor_desc<8x16xf16> -> vector<8x16xf16>
      %4 = xegpu.create_nd_tdesc %arg1[%1, %0] : memref<32x32xf16> -> !xegpu.tensor_desc<16x8xf16>
      %5 = vector.transpose %3, [1, 0] : vector<8x16xf16> to vector<16x8xf16>
      xegpu.store_nd %5, %4  : vector<16x8xf16>, !xegpu.tensor_desc<16x8xf16>
      gpu.return
    }
  }
