...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel  {
    ...
    gpu.func @test_store_scatter(%arg0: memref<16x4xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %alloc = memref.alloc() : memref<64xf32, 3>
      %0 = xegpu.create_tdesc %alloc, %cst_1 : memref<64xf32, 3>, vector<16xindex> -> !xegpu.tensor_desc<16x4xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 4 : i64>>
      %1 = vector.transpose %cst, [1, 0] : vector<4x16xf32> to vector<16x4xf32>
      xegpu.store %1, %0, %cst_0  : vector<16x4xf32>, !xegpu.tensor_desc<16x4xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 4 : i64>>, vector<16xi1>
      %2 = xegpu.load %0, %cst_0  : !xegpu.tensor_desc<16x4xf32, #xegpu.scatter_tdesc_attr<memory_space =  slm, chunk_size = 4 : i64>>, vector<16xi1> -> vector<16x4xf32>
      %reinterpret_cast = memref.reinterpret_cast %arg0 to offset: [0], sizes: [64], strides: [1] : memref<16x4xf32> to memref<64xf32>
      %3 = xegpu.create_tdesc %reinterpret_cast, %cst_1 : memref<64xf32>, vector<16xindex> -> !xegpu.tensor_desc<16x4xf32, #xegpu.scatter_tdesc_attr<chunk_size = 4 : i64>>
      xegpu.store %2, %3, %cst_0  : vector<16x4xf32>, !xegpu.tensor_desc<16x4xf32, #xegpu.scatter_tdesc_attr<chunk_size = 4 : i64>>, vector<16xi1>
      gpu.return
    }
  }
