...
module @gemm attributes {gpu.container_module} {
  memref.global "private" constant @__constant_1x16xf32 : memref<1x16xf32> = dense<1.000000e+00>
  memref.global "private" constant @__constant_3x16xf32 : memref<1x16xf32> = dense<3.300000e+00>
  ...
  gpu.module @test_kernel  {
    gpu.func @test_scattered(%arg0: memref<1x16xf32>, %arg1: memref<1x16xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %cst_0 = arith.constant dense<[true, true, true, false, true, true, true, true, false, true, true, true, true, false, true, true]> : vector<16xi1>
