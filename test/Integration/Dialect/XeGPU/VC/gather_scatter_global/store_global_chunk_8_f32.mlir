...
module @gemm attributes {gpu.container_module} {
  func.func @test() -> memref<16x8xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_store_scatter blocks in (%c1, %c1, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<16x8xf32>)
    %alloc = memref.alloc() : memref<16x8xf32>
    gpu.memcpy  %alloc, %memref : memref<16x8xf32>, memref<16x8xf32>
    gpu.dealloc  %memref : memref<16x8xf32>
    return %alloc : memref<16x8xf32>
  }
  gpu.module @test_kernel  {
    gpu.func @test_store_scatter(%arg0: memref<16x8xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %0 = xegpu.create_tdesc %reinterpret_cast, %cst_1 : memref<128xf32>, vector<16xindex> -> !xegpu.tensor_desc<16x8xf32, #xegpu.scatter_tdesc_attr<chunk_size = 8 : i64>>
      %1 = vector.transpose %cst, [1, 0] : vector<8x16xf32> to vector<16x8xf32>
      xegpu.store %1, %0, %cst_0  : vector<16x8xf32>, !xegpu.tensor_desc<16x8xf32, #xegpu.scatter_tdesc_attr<chunk_size = 8 : i64>>, vector<16xi1>
      gpu.return
    }
  }
