...
module @gemm attributes {gpu.container_module} {
  gpu.module @kernel {
    gpu.func @load_store_2d(%src: memref<128xf32, 1>, %dst: memref<128xf32, 1>) kernel {
        ...
        %loaded = xegpu.load %srcce[%tid_x], %mask <{l1_hint = #xegpu.cache_hint<cached>, l2_hint = #xegpu.cache_hint<uncached>, chunk_size = 1}>: memref<128xf32>, index, i1 -> vector<1xf32>
        ...
        xegpu.store %loaded_modified, %dstte[%tid_x], %mask <{l1_hint = #xegpu.cache_hint<write_back>, l2_hint = #xegpu.cache_hint<uncached>, chunk_size = 1}> : vector<1xf32>, memref<128xf32>, index, i1
        gpu.return
    }
  }
