...
module attributes {
  ...
  func.func @addt(%arg0: memref<2x5xf32>, %arg1: memref<2x5xf32>) -> memref<2x5xf32> {
    ...
    %memref = gpu.alloc host_shared () : memref<2x5xf32>
    memref.copy %arg1, %memref : memref<2x5xf32> to memref<2x5xf32>
    %memref_0 = gpu.alloc host_shared () : memref<2x5xf32>
    memref.copy %arg0, %memref_0 : memref<2x5xf32> to memref<2x5xf32>
    %memref_1 = gpu.alloc host_shared () : memref<2x5xf32>
    gpu.launch_func  @addt_kernel::@addt_kernel blocks in (%c2, %c5, %c1) threads in (%c1, %c1, %c1) args(%memref_0 : memref<2x5xf32>, %memref : memref<2x5xf32>, %memref_1 : memref<2x5xf32>)
    memref.copy %memref_1, %alloc : memref<2x5xf32> to memref<2x5xf32>
