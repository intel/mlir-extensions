...
module @conv_layout attributes {gpu.container_module} {
  ...
  gpu.module @kernel  {
    gpu.func @test_convert_layout(%arg0: memref<64x64xf32>, %arg1: memref<64x64xf32>, %arg2: memref<64x64xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %0 = xetile.init_tile %arg0[%block_id_x, %block_id_y] : memref<64x64xf32> -> !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [16, 2], sg_data = [4, 32]>>>
      %1 = xetile.load_tile %0 : !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [16, 2], sg_data = [4, 32]>>> -> vector<64x64xf32>
      %2 = xetile.convert_layout %1 {wg_map_result = #xetile.wg_map<sg_layout = [8, 4], sg_data = [8, 16]>, wg_map_source = #xetile.wg_map<sg_layout = [16, 2], sg_data = [4, 32]>} : vector<64x64xf32>
      %3 = xetile.init_tile %arg1[%block_id_x, %block_id_y] : memref<64x64xf32> -> !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [8, 4], sg_data = [8, 16]>>>
      %4 = xetile.load_tile %3 : !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [8, 4], sg_data = [8, 16]>>> -> vector<64x64xf32>
      %5 = arith.addf %4, %2 {map = #xetile.wg_map<sg_layout = [8, 4], sg_data = [8, 16]>} : vector<64x64xf32>
      %6 = xetile.init_tile %arg2[%block_id_x, %block_id_y] : memref<64x64xf32> -> !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [8, 4], sg_data = [8, 16]>>>
      xetile.store_tile %5,  %6 : vector<64x64xf32>, !xetile.tile<64x64xf32, #xetile.tile_attr<wg_map = <sg_layout = [8, 4], sg_data = [8, 16]>>>
      gpu.return
    }
  }
