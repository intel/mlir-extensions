  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16>, %arg2: memref<1024x1024xf32>, %arg3: memref<1x1024xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %7:4 = scf.for %arg4 = %c0 to %c1024 step %c32 iter_args(%arg5 = %4, %arg6 = %5, %arg7 = %6, %arg8 = %3) -> (!xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, !xetile.tile<1x32xf16>, vector<16x32xf32>) {
        ...
        %11 = vector.shape_cast %10 : vector<1x32xf16> to vector<32xf16>
        %12 = vector.shape_cast %11 : vector<32xf16> to vector<32x1xf16>
        %13 = xetile.broadcast %12 [1] : vector<32x1xf16> -> vector<32x32xf16>
        %14 = arith.addf %9, %13 : vector<32x32xf16>
        %15 = xetile.tile_mma %8, %14, %arg8 : vector<16x32xf16>, vector<32x32xf16>, vector<16x32xf32> -> vector<16x32xf32>
        %16 = xetile.update_tile_offset %arg5, [%c0, %c32] : !xetile.tile<16x32xf16>
        %17 = xetile.update_tile_offset %arg6, [%c32, %c0] : !xetile.tile<32x32xf16>
        %18 = xetile.update_tile_offset %arg7, [%c0, %c32] : !xetile.tile<1x32xf16>
        scf.yield %16, %17, %18, %15 : !xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, !xetile.tile<1x32xf16>, vector<16x32xf32>
      }
