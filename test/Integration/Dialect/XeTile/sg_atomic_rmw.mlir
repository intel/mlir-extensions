...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<1024xf32>, %arg1: memref<1024xf32>) -> memref<1024xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.memcpy  %alloc, %memref : memref<1024xf32>, memref<1024xf32>
  ...
  gpu.module @test_kernel {
    gpu.func @add_kernel(%arg0: memref<1024xf32>, %arg1: memref<1024xf32>, %arg2: memref<1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %3:3 = scf.for %arg3 = %c0 to %c1024 step %c32 iter_args(%arg4 = %0, %arg5 = %1, %arg6 = %2) -> (!xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>) {
        %4 = xetile.load %arg5, %cst_1 : !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, vector<1x32xi1> -> vector<1x32xf32>
        %5 = xetile.atomic_rmw addf %4, %arg4 : vector<1x32xf32>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>> -> vector<1x32xf32>
        xetile.store %5, %arg6, %cst_1 : vector<1x32xf32>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, vector<1x32xi1>
        %6 = xetile.update_tile_offset %arg4, %cst_0 : !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, vector<1x32xindex>
        %7 = xetile.update_tile_offset %arg5, %cst_0 : !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, vector<1x32xindex>
        %8 = xetile.update_tile_offset %arg6, %cst_0 : !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, vector<1x32xindex>
        scf.yield %6, %7, %8 : !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>, !xetile.tile<1x32xf32, #xetile.tile_attr<scattered = true>>
      }
      gpu.return
    }
  }
