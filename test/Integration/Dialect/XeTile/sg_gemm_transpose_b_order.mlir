...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%A: memref<1024x1024xf16>, %B: memref<1024x1024xf16>, %C: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %B_cast = memref.reinterpret_cast %B to offset : [0], sizes : [1024,1024], strides : [1, 1024] : memref<1024x1024xf16> to memref<1024x1024xf16, strided<[1, 1024], offset:0>>
      %b_init_tile = xetile.init_tile %B_cast[%c0, %n] : memref<1024x1024xf16, strided<[1, 1024], offset:0>> -> !xetile.tile<32x32xf16, #xetile.tile_attr<order=[0, 1]>>
      ...
      %out:3 = scf.for %k = %c0 to %c1024 step %c32
        ...
        %b_next_tile = xetile.update_tile_offset %b_tile, [%c32, %c0]
          : !xetile.tile<32x32xf16, #xetile.tile_attr<order=[0, 1]>>, index, index -> !xetile.tile<32x32xf16, #xetile.tile_attr<order=[0, 1]>>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %C_zeros = memref.cast %C : memref<1024x1024xf32> to memref<*xf32>
    %C_ref_zeros = memref.cast %C_ref : memref<1024x1024xf32> to memref<*xf32>
    ...
    // %C_row_0 = memref.subview %2[1, 0][1, 1024][1, 1] : memref<1024x1024xf32> to memref<1x1024xf32, strided<[1024, 1], offset: 1024>>
    // %C_row_0_cast = memref.cast %C_row_0 : memref<1x1024xf32, strided<[1024, 1], offset: 1024>>to memref<*xf32>
