...
module @gemm attributes {gpu.container_module} {
  func.func @test(%A: memref<64x64xf16>) -> memref<128x64xf16> attributes {llvm.emit_c_interface} {
    %c1 = arith.constant 1 : index
    %c4 = arith.constant 4 : index
    %c8 = arith.constant 8 : index
    %A_gpu = gpu.alloc  host_shared () : memref<64x64xf16>
    memref.copy %A, %A_gpu : memref<64x64xf16> to memref<64x64xf16>
    %B_gpu = gpu.alloc  host_shared () : memref<128x64xf16>
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c1, %c1, %c1) threads in (%c8, %c4, %c1) args(%A_gpu : memref<64x64xf16>, %B_gpu : memref<128x64xf16>)
    gpu.dealloc  %A_gpu : memref<64x64xf16>
    return %B_gpu : memref<128x64xf16>
  }
  gpu.module @test_kernel attributes {spirv.target_env = #spirv.target_env<#spirv.vce<v1.4, [Addresses, Float16Buffer, Int64, Int16, Int8, Kernel, Linkage, Vector16, GenericPointer, Groups, Float16, Float64, AtomicFloat32AddEXT, ExpectAssumeKHR, SubgroupDispatch, VectorComputeINTEL, VectorAnyINTEL], [SPV_EXT_shader_atomic_float_add, SPV_KHR_expect_assume, SPV_INTEL_vector_compute]>, api=OpenCL, #spirv.resource_limits<>>} {
    gpu.func @test_kernel(%A: memref<64x64xf16>, %B: memref<128x64xf16>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %m2 = arith.muli %tid_x, %c16 : index

      %r = arith.remsi %m2, %c64 : index
      %ld_tile = xetile.init_tile %view[%r, %n] : memref<64x64xf16, 3> -> !xetile.tile<16x16xf16, #xetile.tile_attr<memory_space=3>>
      %d = xetile.load_tile %ld_tile : !xetile.tile<16x16xf16, #xetile.tile_attr<memory_space=3>> -> vector<16x16xf16>

      %b_tile = xetile.init_tile %B[%m2, %n] : memref<128x64xf16> -> !xetile.tile<16x16xf16>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %B = call @test(%A) : (memref<64x64xf16>) -> memref<128x64xf16>
    %cast = memref.cast %B : memref<128x64xf16> to memref<*xf16>
