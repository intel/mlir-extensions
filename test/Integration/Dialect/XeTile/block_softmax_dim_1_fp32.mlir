...
module @block_softmax attributes {gpu.container_module} {
  func.func @block_softmax_test(%arg0: memref<1024x1024xf32>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @kernel::@block_softmax_dim_1 blocks in (%c64, %c32, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<1024x1024xf32>, %memref_0 : memref<1024x1024xf32>)
    ...
    // the kernel is a 16x32 block softmax. each thread is assigned with a 16x32 block, and do softmax along dim-1 independently.
  gpu.module @kernel  {
    gpu.func @block_softmax_dim_1(%arg0: memref<1024x1024xf32>, %arg1: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %5 = xetile.reduction <add>, %4 [1] : vector<16x32xf32> -> vector<16x1xf32>
      %6 = xetile.broadcast %5 [1] : vector<16x1xf32> -> vector<16x32xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    // step 2: sum and div along dim-1
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      %1 = scf.for %arg1 = %c0 to %c1024 step %c1 iter_args(%arg2 = %cst) -> (f32) {
        %3 = memref.load %alloc_2[%arg0, %arg1] : memref<1024x1024xf32>
      ...
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        memref.store %4, %alloc_2[%arg0, %arg1] : memref<1024x1024xf32>
      }
    }
