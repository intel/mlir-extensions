...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16>, %arg2: memref<1024x1024xf32>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c8, %c8, %c1) threads in (%c4, %c4, %c1)  args(%memref : memref<1024x1024xf16>, %memref_0 : memref<1024x1024xf16>, %memref_1 : memref<1024x1024xf32>)
  ...
  gpu.module @test_kernel  {
    ...
    gpu.func @test_kernel(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16>, %arg2: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %5 = xetile.init_tile %arg1[%c0, %1] : memref<1024x1024xf16> -> !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [128, 32]>>>
      %6:3 = scf.for %arg3 = %c0 to %c1024 step %c128 iter_args(%arg4 = %4, %arg5 = %5, %arg6 = %3) -> (!xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [32, 128]>>>, !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [128, 32]>>>, vector<128x128xf32>) {
        %7 = xetile.load_tile %arg4 : !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [32, 128]>>> -> vector<128x128xf16>
        %8 = xetile.load_tile %arg5 : !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [128, 32]>>> -> vector<128x128xf16>
        %9 = xetile.tile_mma %7, %8, %arg6 {wg_map_a = #xetile.wg_map<sg_layout = [4, 4], sg_data = [32, 128]>, wg_map_b = #xetile.wg_map<sg_layout = [4, 4], sg_data = [128, 32]>, wg_map_c = #xetile.wg_map<sg_layout = [4, 4], sg_data = [32, 32]>} : vector<128x128xf16>, vector<128x128xf16>, vector<128x128xf32> -> vector<128x128xf32>
        %10 = xetile.update_tile_offset %arg4, [%c0, %c128] : !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [32, 128]>>>
        %11 = xetile.update_tile_offset %arg5, [%c128, %c0] : !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [128, 32]>>>
        scf.yield %10, %11, %9 : !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [32, 128]>>>, !xetile.tile<128x128xf16, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [128, 32]>>>, vector<128x128xf32>
      }
      xetile.store_tile %6#2,  %2 : vector<128x128xf32>, !xetile.tile<128x128xf32, #xetile.tile_attr<wg_map = <sg_layout = [4, 4], sg_data = [32, 32]>>>
      gpu.return
    }
  }
