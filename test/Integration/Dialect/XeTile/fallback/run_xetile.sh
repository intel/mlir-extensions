...
# PIPELINE=$ROOT/test/Integration/Dialect/XeTile/xetile-wg-to-func-vc.pp
PIPELINE=$ROOT/test/Integration/Dialect/XeTile/fallback/xetile-fallback-to-func-vc.pp
