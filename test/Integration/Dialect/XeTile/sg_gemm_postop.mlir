...
module @gemm attributes {gpu.container_module} {
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<256x256xf16>, %arg1: memref<256x256xf16>, %arg2: memref<256x256xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %5 = xetile.init_tile %arg1[%c0, %1] : memref<256x256xf16> -> !xetile.tile<32x32xf16>
      %6:3 = scf.for %arg3 = %c0 to %c256 step %c32 iter_args(%arg4 = %4, %arg5 = %5, %arg6 = %3) -> (!xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, vector<16x32xf32>) {
        %8 = xetile.load_tile %arg4 : !xetile.tile<16x32xf16> -> vector<16x32xf16>
        %9 = xetile.load_tile %arg5 : !xetile.tile<32x32xf16> -> vector<32x32xf16>
        %10 = xetile.tile_mma %8, %9, %arg6 : vector<16x32xf16>, vector<32x32xf16>, vector<16x32xf32> -> vector<16x32xf32>
      ...
      %7 = math.exp %6#2 : vector<16x32xf32>
      xetile.store_tile %7,  %2 : vector<16x32xf32>, !xetile.tile<16x32xf32>
      gpu.return
    }
  }
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg0 = %c0 to %c256 step %c1 {
      scf.for %arg1 = %c0 to %c256 step %c1 {
        ...
        memref.store %2, %alloc[%arg0, %arg1] : memref<256x256xf16>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c256 step %c1 {
      scf.for %arg1 = %c0 to %c256 step %c1 {
        ...
        scf.if %3 {
          memref.store %cst_1, %alloc_2[%arg0, %arg1] : memref<256x256xf16>
        } else {
          memref.store %cst_0, %alloc_2[%arg0, %arg1] : memref<256x256xf16>
        }
      }
    }
    ...
    scf.for %arg0 = %c0 to %c256 step %c1 {
      scf.for %arg1 = %c0 to %c256 step %c1 {
        ...
        %2 = scf.for %arg2 = %c0 to %c256 step %c1 iter_args(%arg3 = %1) -> (f32) {
          %4 = memref.load %alloc[%arg0, %arg2] : memref<256x256xf16>
          %5 = memref.load %alloc_2[%arg2, %arg1] : memref<256x256xf16>
          %6 = arith.mulf %4, %5 : f16
          %7 = arith.extf %6 : f16 to f32
          %8 = arith.addf %7, %arg3 : f32
          scf.yield %8 : f32
        }
        %3 = math.exp %2 : f32
        memref.store %3, %alloc_4[%arg0, %arg1] : memref<256x256xf32>
      }
    }
    ...
    // %C_row_0 = memref.subview %2[0, 0][1, 256][1, 1] : memref<256x256xf32> to memref<1x256xf32>
    // %C_row_0_cast = memref.cast %C_row_0 : memref<1x256xf32> to memref<*xf32>
    // call @printMemrefF32(%C_row_0_cast) : (memref<*xf32>) -> ()
    // %C_ref_row_0 = memref.subview %C_ref[0, 0][1, 256][1, 1] : memref<256x256xf32> to memref<1x256xf32>
    // %C_ref_row_0_cast = memref.cast %C_ref_row_0 : memref<1x256xf32> to memref<*xf32>
