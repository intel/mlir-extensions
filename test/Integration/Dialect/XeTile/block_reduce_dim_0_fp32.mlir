...
module @softmax attributes {gpu.container_module} {
  func.func @reduce_test(%arg0: memref<16x1024xf32>) -> memref<1x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    %memref = gpu.alloc  () : memref<16x1024xf32>
    gpu.memcpy  %memref, %arg0 : memref<16x1024xf32>, memref<16x1024xf32>
    %memref_0 = gpu.alloc  () : memref<1x1024xf32>
    gpu.launch_func  @kernel::@reduce_dim_1 blocks in (%c1, %c32, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<16x1024xf32>, %memref_0 : memref<1x1024xf32>)
    gpu.dealloc  %memref : memref<16x1024xf32>
  ...
  gpu.module @kernel  {
    gpu.func @reduce_dim_1(%arg0: memref<16x1024xf32>, %arg1: memref<1x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      %c1 = arith.constant 1 : index
      ...
      %2 = xetile.init_tile %arg0[%0, %1] : memref<16x1024xf32> -> !xetile.tile<16x32xf32>
      %3 = xetile.load_tile %2 : !xetile.tile<16x32xf32> -> vector<16x32xf32>
      %4 = xetile.reduction <add>, %3 [0] : vector<16x32xf32> -> vector<1x32xf32>
      %5 = xetile.init_tile %arg1[0, %1] : memref<1x1024xf32> -> !xetile.tile<1x32xf32>
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %alloc = memref.alloc() : memref<16x1024xf32>
    ...
    scf.for %arg0 = %c0 to %c16 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        memref.store %3, %alloc[%arg0, %arg1] : memref<16x1024xf32>
      }
    }
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      %1 = scf.for %arg1 = %c0 to %c16 step %c1 iter_args(%arg2 = %cst) -> (f32) {
        %2 = memref.load %alloc[%arg1, %arg0] : memref<16x1024xf32>
    ...
    // CHECK: [ALLCLOSE: TRUE]
    %0 = call @reduce_test(%alloc) : (memref<16x1024xf32>) -> memref<1x1024xf32>
    ...
    memref.dealloc %alloc : memref<16x1024xf32>
