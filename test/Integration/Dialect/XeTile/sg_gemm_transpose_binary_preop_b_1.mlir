...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16>, %arg2: memref<1024x1024xf16>, %arg3: memref<1024x1024xf32>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.memcpy  %memref_1, %arg2 : memref<1024x1024xf16>, memref<1024x1024xf16>
    %memref_2 = gpu.alloc  () : memref<1024x1024xf32>
    gpu.memcpy  %memref_2, %arg3 : memref<1024x1024xf32>, memref<1024x1024xf32>
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c64, %c32, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<1024x1024xf16>, %memref_0 : memref<1024x1024xf16>, %memref_1 : memref<1024x1024xf16>, %memref_2 : memref<1024x1024xf32>)
    gpu.dealloc  %memref : memref<1024x1024xf16>
    gpu.dealloc  %memref_0 : memref<1024x1024xf16>
    gpu.dealloc  %memref_1 : memref<1024x1024xf16>
    %alloc = memref.alloc() : memref<1024x1024xf32>
    gpu.memcpy  %alloc, %memref_2 : memref<1024x1024xf32>, memref<1024x1024xf32>
    gpu.dealloc  %memref_2 : memref<1024x1024xf32>
    return %alloc : memref<1024x1024xf32>
  }
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16>, %arg2: memref<1024x1024xf16>, %arg3: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %2 = xetile.init_tile %arg3[%0, %1] : memref<1024x1024xf32> -> !xetile.tile<16x32xf32>
      ...
      %5 = xetile.init_tile %arg1[%1, %c0] : memref<1024x1024xf16> -> !xetile.tile<32x32xf16>
      %6 = xetile.init_tile %arg2[%1, %c0] : memref<1024x1024xf16> -> !xetile.tile<32x32xf16>
      %7:4 = scf.for %arg4 = %c0 to %c1024 step %c32 iter_args(%arg5 = %4, %arg6 = %5, %arg7 = %6, %arg8 = %3) -> (!xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, !xetile.tile<32x32xf16>, vector<16x32xf32>) {
        ...
        %10 = vector.transpose %9, [1, 0] : vector<32x32xf16> to vector<32x32xf16>
        %11 = xetile.load_tile %arg7 : !xetile.tile<32x32xf16> -> vector<32x32xf16>
        %12 = vector.transpose %11, [1, 0] : vector<32x32xf16> to vector<32x32xf16>
        %13 = arith.addf %10, %12 : vector<32x32xf16>
        %14 = xetile.tile_mma %8, %13, %arg8 : vector<16x32xf16>, vector<32x32xf16>, vector<16x32xf32> -> vector<16x32xf32>
        %15 = xetile.update_tile_offset %arg5, [%c0, %c32] : !xetile.tile<16x32xf16>
        %16 = xetile.update_tile_offset %arg6, [%c0, %c32] : !xetile.tile<32x32xf16>
        %17 = xetile.update_tile_offset %arg7, [%c0, %c32] : !xetile.tile<32x32xf16>
        scf.yield %15, %16, %17, %14 : !xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, !xetile.tile<32x32xf16>, vector<16x32xf32>
      }
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        memref.store %2, %alloc_2[%arg0, %arg1] : memref<1024x1024xf16>
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        %2 = scf.for %arg2 = %c0 to %c1024 step %c1 iter_args(%arg3 = %1) -> (f32) {
          ...
          %4 = memref.load %alloc_2[%arg1, %arg2] : memref<1024x1024xf16>
          %5 = memref.load %alloc_3[%arg1, %arg2] : memref<1024x1024xf16>
          %6 = arith.addf %4, %5 : f16
          %7 = arith.mulf %3, %6 : f16
    ...
    // CHECK: [ALLCLOSE: TRUE]
    %0 = call @test(%alloc, %alloc_2, %alloc_3, %alloc_4) : (memref<1024x1024xf16>, memref<1024x1024xf16>, memref<1024x1024xf16>, memref<1024x1024xf32>) -> memref<1024x1024xf32>
    %cast = memref.cast %0 : memref<1024x1024xf32> to memref<*xf32>
    %cast_6 = memref.cast %alloc_5 : memref<1024x1024xf32> to memref<*xf32>
    call @printAllcloseF32(%cast, %cast_6) : (memref<*xf32>, memref<*xf32>) -> ()
