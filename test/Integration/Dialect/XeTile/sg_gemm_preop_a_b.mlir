  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<256x256xf16>, %arg1: memref<256x256xf16>, %arg2: memref<256x256xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %6:3 = scf.for %arg3 = %c0 to %c256 step %c32 iter_args(%arg4 = %4, %arg5 = %5, %arg6 = %3) -> (!xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, vector<16x32xf32>) {
        ...
        %9 = arith.addf %7, %7 : vector<16x32xf16>
        %10 = arith.addf %8, %8 : vector<32x32xf16>
        %11 = xetile.tile_mma %9, %10, %arg6 : vector<16x32xf16>, vector<32x32xf16>, vector<16x32xf32> -> vector<16x32xf32>
        %12 = xetile.update_tile_offset %arg4, [%c0, %c32] : !xetile.tile<16x32xf16>
        %13 = xetile.update_tile_offset %arg5, [%c32, %c0] : !xetile.tile<32x32xf16>
        scf.yield %12, %13, %11 : !xetile.tile<16x32xf16>, !xetile.tile<32x32xf16>, vector<16x32xf32>
      }
    ...
    scf.for %arg0 = %c0 to %c256 step %c1 {
      scf.for %arg1 = %c0 to %c256 step %c1 {
        ...
        %2 = scf.for %arg2 = %c0 to %c256 step %c1 iter_args(%arg3 = %1) -> (f32) {
          ...
          %4 = memref.load %alloc_2[%arg2, %arg1] : memref<256x256xf16>
          %5 = arith.addf %3, %3 : f16
          %6 = arith.addf %4, %4 : f16
