...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16, strided<[1, 1024]>>, %arg2: memref<1024x1024xf32>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    // gpu.memcpy only works on memref with identity layout
    // We have to:
    // - reinterpret cast the coloumn-major memref to row-major (identity layout) one
    // - do gpu.memcpy on identiy memref
    // - reinterpret cast back the gpu buffer to coloumn-major
    %memref_0 = gpu.alloc  () : memref<1024x1024xf16>
    %b_host_reinterpret_cast = memref.reinterpret_cast %arg1 to offset:  [0], sizes: [1024, 1024], strides: [1024, 1] : memref<1024x1024xf16, strided<[1, 1024]>> to memref<1024x1024xf16>
    gpu.memcpy %memref_0, %b_host_reinterpret_cast : memref<1024x1024xf16>, memref<1024x1024xf16>
    %reinterpret_cast = memref.reinterpret_cast %memref_0 to offset: [0], sizes: [1024, 1024], strides: [1, 1024] : memref<1024x1024xf16> to memref<1024x1024xf16, strided<[1, 1024]>>
    %memref_1 = gpu.alloc  () : memref<1024x1024xf32>
    gpu.memcpy  %memref_1, %arg2 : memref<1024x1024xf32>, memref<1024x1024xf32>
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c64, %c32, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<1024x1024xf16>, %reinterpret_cast : memref<1024x1024xf16, strided<[1, 1024]>>, %memref_1 : memref<1024x1024xf32>)
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1024xf16>, %arg1: memref<1024x1024xf16, strided<[1, 1024]>>, %arg2: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %5 = xetile.init_tile %arg1[%1, %c0] : memref<1024x1024xf16, strided<[1, 1024]>> -> !xetile.tile<32x32xf16, #xetile.tile_attr<order = [0, 1]>>
      %6:3 = scf.for %arg3 = %c0 to %c1024 step %c32 iter_args(%arg4 = %4, %arg5 = %5, %arg6 = %3) -> (!xetile.tile<16x32xf16>, !xetile.tile<32x32xf16, #xetile.tile_attr<order = [0, 1]>>, vector<16x32xf32>) {
        ...
        %9 = vector.transpose %8, [1, 0] : vector<32x32xf16> to vector<32x32xf16>
        %10 = xetile.tile_mma %7, %9, %arg6 : vector<16x32xf16>, vector<32x32xf16>, vector<16x32xf32> -> vector<16x32xf32>
        %11 = xetile.update_tile_offset %arg4, [%c0, %c32] : !xetile.tile<16x32xf16>
        %12 = xetile.update_tile_offset %arg5, [%c0, %c32] : !xetile.tile<32x32xf16, #xetile.tile_attr<order = [0, 1]>>
        scf.yield %11, %12, %10 : !xetile.tile<16x32xf16>, !xetile.tile<32x32xf16, #xetile.tile_attr<order = [0, 1]>>, vector<16x32xf32>
      }
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    %reinterpret_cast = memref.reinterpret_cast %alloc_2 to offset: [0], sizes: [1024, 1024], strides: [1, 1024] : memref<1024x1024xf16> to memref<1024x1024xf16, strided<[1, 1024]>>
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        memref.store %2, %reinterpret_cast[%arg0, %arg1] : memref<1024x1024xf16, strided<[1, 1024]>>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        scf.if %3 {
          memref.store %cst_1, %alloc[%arg0, %arg1] : memref<1024x1024xf16>
        } else {
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        %2 = scf.for %arg2 = %c0 to %c1024 step %c1 iter_args(%arg3 = %1) -> (f32) {
          ...
          %4 = memref.load %reinterpret_cast[%arg1, %arg2] : memref<1024x1024xf16, strided<[1, 1024]>>
    ...
    %0 = call @test(%alloc, %reinterpret_cast, %alloc_3) : (memref<1024x1024xf16>, memref<1024x1024xf16, strided<[1, 1024]>>, memref<1024x1024xf32>) -> memref<1024x1024xf32>
