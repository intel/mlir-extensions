...
module @gemm attributes {gpu.container_module} {
  func.func @test(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xf32>) -> memref<1024x1024xf32> attributes {llvm.emit_c_interface} {
    ...
    gpu.launch_func  @test_kernel::@test_kernel blocks in (%c64, %c32, %c1) threads in (%c1, %c1, %c1)  args(%memref : memref<1024x1024xbf16>, %memref_0 : memref<1024x1024xbf16>, %memref_1 : memref<1024x1024xf32>)
  ...
  gpu.module @test_kernel  {
    gpu.func @test_kernel(%arg0: memref<1024x1024xbf16>, %arg1: memref<1024x1024xbf16>, %arg2: memref<1024x1024xf32>) kernel attributes {VectorComputeFunctionINTEL, spirv.entry_point_abi = #spirv.entry_point_abi<>} {
      ...
      %4 = xetile.init_tile %arg0[%0, %c0] : memref<1024x1024xbf16> -> !xetile.tile<16x32xbf16>
      %5 = xetile.init_tile %arg1[%c0, %1] : memref<1024x1024xbf16> -> !xetile.tile<32x32xbf16>
      %6:3 = scf.for %arg3 = %c0 to %c1024 step %c32 iter_args(%arg4 = %4, %arg5 = %5, %arg6 = %3) -> (!xetile.tile<16x32xbf16>, !xetile.tile<32x32xbf16>, vector<16x32xf32>) {
        %7 = xetile.load_tile %arg4 : !xetile.tile<16x32xbf16> -> vector<16x32xbf16>
        %8 = xetile.load_tile %arg5 : !xetile.tile<32x32xbf16> -> vector<32x32xbf16>
        %9 = xetile.tile_mma %7, %8, %arg6 : vector<16x32xbf16>, vector<32x32xbf16>, vector<16x32xf32> -> vector<16x32xf32>
        %10 = xetile.update_tile_offset %arg4, [%c0, %c32] : !xetile.tile<16x32xbf16>
        %11 = xetile.update_tile_offset %arg5, [%c32, %c0] : !xetile.tile<32x32xbf16>
        scf.yield %10, %11, %9 : !xetile.tile<16x32xbf16>, !xetile.tile<32x32xbf16>, vector<16x32xf32>
      }
  ...
  func.func @main() attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        scf.if %3 {
          memref.store %cst_1, %alloc_2[%arg0, %arg1] : memref<1024x1024xbf16>
        } else {
          memref.store %cst_0, %alloc_2[%arg0, %arg1] : memref<1024x1024xbf16>
        }
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1024 step %c1 {
      scf.for %arg1 = %c0 to %c1024 step %c1 {
        ...
        %2 = scf.for %arg2 = %c0 to %c1024 step %c1 iter_args(%arg3 = %1) -> (f32) {
          %3 = memref.load %alloc[%arg0, %arg2] : memref<1024x1024xbf16>
          %4 = memref.load %alloc_2[%arg2, %arg1] : memref<1024x1024xbf16>
          %5 = arith.mulf %3, %4 : bf16
    ...
    // CHECK: [ALLCLOSE: TRUE]
    %0 = call @test(%alloc, %alloc_2, %alloc_3) : (memref<1024x1024xbf16>, memref<1024x1024xbf16>, memref<1024x1024xf32>) -> memref<1024x1024xf32>
    ...
    memref.dealloc %alloc_2 : memref<1024x1024xbf16>
