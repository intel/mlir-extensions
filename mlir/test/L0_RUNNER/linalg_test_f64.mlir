...
module @jit_func.func.0 {
  func.func public @foo(%arg0: tensor<500xf64>, %arg1: tensor<5xf64>) -> tensor<500xf64> {
    ...
    %16 = tensor.empty() : tensor<500xf64>
    ...
    %18 = tensor.empty() : tensor<500xf64>
    ...
    %24 = tensor.empty() : tensor<500xf64>
    ...
    %26 = tensor.empty() : tensor<500xf64>
    ...
    %40 = tensor.empty() : tensor<500xf64>
