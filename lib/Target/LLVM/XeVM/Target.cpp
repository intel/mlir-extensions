...
void imex::xevm::SerializeGPUModuleBase::init() {
...
gpu::GPUModuleOp SpirSerializer::getOperation() {
  return dyn_cast<gpu::GPUModuleOp>(
      &imex::xevm::SerializeGPUModuleBase::getOperation());
}
...
SpirSerializer::moduleToObject(llvm::Module &llvmModule) {
  ...
  if (targetOptions.getCompilationTarget() == gpu::CompilationTarget::Offload)
    return imex::xevm::SerializeGPUModuleBase::moduleToObject(llvmModule);
